 ...
 */const vd=function(i){const t=[];let e=0;for(let n=0;n<i.length;n++){let s=i.charCodeAt(n);s<128?t[e++]=s:s<2048?(t[e++]=s>>6|192,t[e++]=s&63|128):(s&64512)===55296&&n+1<i.length&&(i.charCodeAt(n+1)&64512)===56320?(s=65536+((s&1023)<<10)+(i.charCodeAt(++n)&1023),t[e++]=s>>18|240,t[e++]=s>>12&63|128,t[e++]=s>>6&63|128,t[e++]=s&63|128):(t[e++]=s>>12|224,t[e++]=s>>6&63|128,t[e++]=s&63|128)}return t},tp=function(i){const t=[];let e=0,n=0;for(;e<i.length;){const s=i[e++];if(s<128)t[n++]=String.fromCharCode(s);else if(s>191&&s<224){const r=i[e++];t[n++]=String.fromCharCode((s&31)<<6|r&63)}else if(s>239&&s<365){const r=i[e++],a=i[e++],l=i[e++],c=((s&7)<<18|(r&63)<<12|(a&63)<<6|l&63)-65536;t[n++]=String.fromCharCode(55296+(c>>10)),t[n++]=String.fromCharCode(56320+(c&1023))}else{const r=i[e++],a=i[e++];t[n++]=String.fromCharCode((s&15)<<12|(r&63)<<6|a&63)}}return t.join("")},yd={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(i,t){if(!Array.isArray(i))throw Error("encodeByteArray takes an array as a parameter");this.init_();const e=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,n=[];for(let s=0;s<i.length;s+=3){const r=i[s],a=s+1<i.length,l=a?i[s+1]:0,c=s+2<i.length,h=c?i[s+2]:0,d=r>>2,p=(r&3)<<4|l>>4;let m=(l&15)<<2|h>>6,y=h&63;c||(y=64,a||(m=64)),n.push(e[d],e[p],e[m],e[y])}return n.join("")},encodeString(i,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(i):this.encodeByteArray(vd(i),t)},decodeString(i,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(i):tp(this.decodeStringToByteArray(i,t))},decodeStringToByteArray(i,t){this.init_();const e=t?this.charToByteMapWebSafe_:this.charToByteMap_,n=[];for(let s=0;s<i.length;){const r=e[i.charAt(s++)],l=s<i.length?e[i.charAt(s)]:0;++s;const h=s<i.length?e[i.charAt(s)]:64;++s;const p=s<i.length?e[i.charAt(s)]:64;if(++s,r==null||l==null||h==null||p==null)throw new ep;const m=r<<2|l>>4;if(n.push(m),h!==64){const y=l<<4&240|h>>2;if(n.push(y),p!==64){const M=h<<6&192|p;n.push(M)}}}return n},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let i=0;i<this.ENCODED_VALS.length;i++)this.byteToCharMap_[i]=this.ENCODED_VALS.charAt(i),this.charToByteMap_[this.byteToCharMap_[i]]=i,this.byteToCharMapWebSafe_[i]=this.ENCODED_VALS_WEBSAFE.charAt(i),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[i]]=i,i>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(i)]=i,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(i)]=i)}}};class ep extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const np=function(i){const t=vd(i);return yd.encodeByteArray(t,!0)},xd=function(i){return np(i).replace(/\./g,"")},Md=function(i){try{return yd.decodeString(i,!0)}catch(t){console.error("base64Decode failed: ",t)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sp=()=>ip().__FIREBASE_DEFAULTS__,rp=()=>{if(typeof process>"u"||typeof rh>"u")return;const i=rh.__FIREBASE_DEFAULTS__;if(i)return JSON.parse(i)},op=()=>{if(typeof document>"u")return;let i;try{i=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=i&&Md(i[1]);return t&&JSON.parse(t)},ap=()=>{try{return Qf()||sp()||rp()||op()}catch(i){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${i}`);return}},lp=i=>{var t;return(t=ap())===null||t===void 0?void 0:t[`_${i}`]};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sd(i){try{return(i.startsWith("http://")||i.startsWith("https://")?new URL(i).hostname:i).endsWith(".cloudworkstations.dev")}catch{return!1}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zn(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function cp(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(zn())}function hp(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function up(){const i=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof i=="object"&&i.id!==void 0}function dp(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function fp(){try{return typeof indexedDB=="object"}catch{return!1}}function pp(){return new Promise((i,t)=>{try{let e=!0;const n="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(n);s.onsuccess=()=>{s.result.close(),e||self.indexedDB.deleteDatabase(n),i(!0)},s.onupgradeneeded=()=>{e=!1},s.onerror=()=>{var r;t(((r=s.error)===null||r===void 0?void 0:r.message)||"")}}catch(e){t(e)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mp="FirebaseError";class wi extends Error{constructor(t,e,n){super(e),this.code=t,this.customData=n,this.name=mp,Object.setPrototypeOf(this,wi.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Rr.prototype.create)}}class Rr{constructor(t,e,n){this.service=t,this.serviceName=e,this.errors=n}create(t,...e){const n=e[0]||{},s=`${this.service}/${t}`,r=this.errors[t],a=r?gp(r,n):"Error",l=`${this.serviceName}: ${a} (${s}).`;return new wi(s,l,n)}}function gp(i,t){return i.replace(_p,(e,n)=>{const s=t[n];return s!=null?String(s):`<${n}?>`})}const _p=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ed(i){const t=[];for(const[e,n]of Object.entries(i))Array.isArray(n)?n.forEach(s=>{t.push(encodeURIComponent(e)+"="+encodeURIComponent(s))}):t.push(encodeURIComponent(e)+"="+encodeURIComponent(n));return t.length?"&"+t.join("&"):""}function vp(i,t){const e=new yp(i,t);return e.subscribe.bind(e)}class yp{constructor(t,e){this.observers=[],this.unsubscribes=[],this.observerCount=0,this.task=Promise.resolve(),this.finalized=!1,this.onNoObservers=e,this.task.then(()=>{t(this)}).catch(n=>{this.error(n)})}next(t){this.forEachObserver(e=>{e.next(t)})}error(t){this.forEachObserver(e=>{e.error(t)}),this.close(t)}complete(){this.forEachObserver(t=>{t.complete()}),this.close()}subscribe(t,e,n){let s;if(t===void 0&&e===void 0&&n===void 0)throw new Error("Missing Observer.");xp(t,["next","error","complete"])?s=t:s={next:t,error:e,complete:n},s.next===void 0&&(s.next=ma),s.error===void 0&&(s.error=ma),s.complete===void 0&&(s.complete=ma);const r=this.unsubscribeOne.bind(this,this.observers.length);return this.finalized&&this.task.then(()=>{try{this.finalError?s.error(this.finalError):s.complete()}catch{}}),this.observers.push(s),r}unsubscribeOne(t){this.observers===void 0||this.observers[t]===void 0||(delete this.observers[t],this.observerCount-=1,this.observerCount===0&&this.onNoObservers!==void 0&&this.onNoObservers(this))}forEachObserver(t){if(!this.finalized)for(let e=0;e<this.observers.length;e++)this.sendOne(e,t)}sendOne(t,e){this.task.then(()=>{if(this.observers!==void 0&&this.observers[t]!==void 0)try{e(this.observers[t])}catch(n){typeof console<"u"&&console.error&&console.error(n)}})}close(t){this.finalized||(this.finalized=!0,t!==void 0&&(this.finalError=t),this.task.then(()=>{this.observers=void 0,this.onNoObservers=void 0}))}}function xp(i,t){if(typeof i!="object"||i===null)return!1;for(const e of t)if(e in i&&typeof i[e]=="function")return!0;return!1}function ma(){}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jo(i){return i&&i._delegate?i._delegate:i}class Us{constructor(t,e,n){this.name=t,this.instanceFactory=e,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var de;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(de||(de={}));const Mp={debug:de.DEBUG,verbose:de.VERBOSE,info:de.INFO,warn:de.WARN,error:de.ERROR,silent:de.SILENT},Sp=de.INFO,Ep={[de.DEBUG]:"log",[de.VERBOSE]:"log",[de.INFO]:"info",[de.WARN]:"warn",[de.ERROR]:"error"},bp=(i,t,...e)=>{if(t<i.logLevel)return;const n=new Date().toISOString(),s=Ep[t];if(s)console[s](`[${n}]  ${i.name}:`,...e);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class ec{constructor(t){this.name=t,this._logLevel=Sp,this._logHandler=bp,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in de))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?Mp[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,de.DEBUG,...t),this._logHandler(this,de.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,de.VERBOSE,...t),this._logHandler(this,de.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,de.INFO,...t),this._logHandler(this,de.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,de.WARN,...t),this._logHandler(this,de.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,de.ERROR,...t),this._logHandler(this,de.ERROR,...t)}}const wp=(i,t)=>t.some(e=>i instanceof e);let oh,ah;function Tp(){return oh||(oh=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Ap(){return ah||(ah=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const bd=new WeakMap,sl=new WeakMap,wd=new WeakMap,ga=new WeakMap,nc=new WeakMap;function Cp(i){const t=new Promise((e,n)=>{const s=()=>{i.removeEventListener("success",r),i.removeEventListener("error",a)},r=()=>{e(Mi(i.result)),s()},a=()=>{n(i.error),s()};i.addEventListener("success",r),i.addEventListener("error",a)});return t.then(e=>{e instanceof IDBCursor&&bd.set(e,i)}).catch(()=>{}),nc.set(t,i),t}function Rp(i){if(sl.has(i))return;const t=new Promise((e,n)=>{const s=()=>{i.removeEventListener("complete",r),i.removeEventListener("error",a),i.removeEventListener("abort",a)},r=()=>{e(),s()},a=()=>{n(i.error||new DOMException("AbortError","AbortError")),s()};i.addEventListener("complete",r),i.addEventListener("error",a),i.addEventListener("abort",a)});sl.set(i,t)}let rl={get(i,t,e){if(i instanceof IDBTransaction){if(t==="done")return sl.get(i);if(t==="objectStoreNames")return i.objectStoreNames||wd.get(i);if(t==="store")return e.objectStoreNames[1]?void 0:e.objectStore(e.objectStoreNames[0])}return Mi(i[t])},set(i,t,e){return i[t]=e,!0},has(i,t){return i instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in i}};function Pp(i){rl=i(rl)}function Ip(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...e){const n=i.call(_a(this),t,...e);return wd.set(n,t.sort?t.sort():[t]),Mi(n)}:Ap().includes(i)?function(...t){return i.apply(_a(this),t),Mi(bd.get(this))}:function(...t){return Mi(i.apply(_a(this),t))}}function Dp(i){return typeof i=="function"?Ip(i):(i instanceof IDBTransaction&&Rp(i),wp(i,Tp())?new Proxy(i,rl):i)}function Mi(i){if(i instanceof IDBRequest)return Cp(i);if(ga.has(i))return ga.get(i);const t=Dp(i);return t!==i&&(ga.set(i,t),nc.set(t,i)),t}const _a=i=>nc.get(i);function Lp(i,t,{blocked:e,upgrade:n,blocking:s,terminated:r}={}){const a=indexedDB.open(i,t),l=Mi(a);return n&&a.addEventListener("upgradeneeded",c=>{n(Mi(a.result),c.oldVersion,c.newVersion,Mi(a.transaction),c)}),e&&a.addEventListener("blocked",c=>e(c.oldVersion,c.newVersion,c)),l.then(c=>{r&&c.addEventListener("close",()=>r()),s&&c.addEventListener("versionchange",h=>s(h.oldVersion,h.newVersion,h))}).catch(()=>{}),l}const Up=["get","getKey","getAll","getAllKeys","count"],Np=["put","add","delete","clear"],va=new Map;function lh(i,t){if(!(i instanceof IDBDatabase&&!(t in i)&&typeof t=="string"))return;if(va.get(t))return va.get(t);const e=t.replace(/FromIndex$/,""),n=t!==e,s=Np.includes(e);if(!(e in(n?IDBIndex:IDBObjectStore).prototype)||!(s||Up.includes(e)))return;const r=async function(a,...l){const c=this.transaction(a,s?"readwrite":"readonly");let h=c.store;return n&&(h=h.index(l.shift())),(await Promise.all([h[e](...l),s&&c.done]))[0]};return va.set(t,r),r}Pp(i=>({...i,get:(t,e,n)=>lh(t,e)||i.get(t,e,n),has:(t,e)=>!!lh(t,e)||i.has(t,e)}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Op{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(Fp(e)){const n=e.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(e=>e).join(" ")}}function Fp(i){const t=i.getComponent();return(t==null?void 0:t.type)==="VERSION"}const ol="@firebase/app",ch="0.13.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const si=new ec("@firebase/app"),Bp="@firebase/app-compat",kp="@firebase/analytics-compat",zp="@firebase/analytics",Vp="@firebase/app-check-compat",Gp="@firebase/app-check",Hp="@firebase/auth",Wp="@firebase/auth-compat",Xp="@firebase/database",qp="@firebase/data-connect",jp="@firebase/database-compat",$p="@firebase/functions",Yp="@firebase/functions-compat",Kp="@firebase/installations",Jp="@firebase/installations-compat",Zp="@firebase/messaging",Qp="@firebase/messaging-compat",tm="@firebase/performance",em="@firebase/performance-compat",nm="@firebase/remote-config",im="@firebase/remote-config-compat",sm="@firebase/storage",rm="@firebase/storage-compat",om="@firebase/firestore",am="@firebase/ai",lm="@firebase/firestore-compat",cm="firebase",hm="11.10.0",um={[ol]:"fire-core",[Bp]:"fire-core-compat",[zp]:"fire-analytics",[kp]:"fire-analytics-compat",[Gp]:"fire-app-check",[Vp]:"fire-app-check-compat",[Hp]:"fire-auth",[Wp]:"fire-auth-compat",[Xp]:"fire-rtdb",[qp]:"fire-data-connect",[jp]:"fire-rtdb-compat",[$p]:"fire-fn",[Yp]:"fire-fn-compat",[Kp]:"fire-iid",[Jp]:"fire-iid-compat",[Zp]:"fire-fcm",[Qp]:"fire-fcm-compat",[tm]:"fire-perf",[em]:"fire-perf-compat",[nm]:"fire-rc",[im]:"fire-rc-compat",[sm]:"fire-gcs",[rm]:"fire-gcs-compat",[om]:"fire-fst",[lm]:"fire-fst-compat",[am]:"fire-vertex","fire-js":"fire-js",[cm]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dm=new Map,fm=new Map,hh=new Map;function uh(i,t){try{i.container.addComponent(t)}catch(e){si.debug(`Component ${t.name} failed to register with FirebaseApp ${i.name}`,e)}}function Ns(i){const t=i.name;if(hh.has(t))return si.debug(`There were multiple attempts to register component ${t}.`),!1;hh.set(t,i);for(const e of dm.values())uh(e,i);for(const e of fm.values())uh(e,i);return!0}function Bi(i){return i==null?!1:i.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zo=hm;function Si(i,t,e){var n;let s=(n=um[i])!==null&&n!==void 0?n:i;e&&(s+=`-${e}`);const r=s.match(/\s|\//),a=t.match(/\s|\//);if(r||a){const l=[`Unable to register library "${s}" with version "${t}":`];r&&l.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&a&&l.push("and"),a&&l.push(`version name "${t}" contains illegal characters (whitespace or "/")`),si.warn(l.join(" "));return}Ns(new Us(`${s}-version`,()=>({library:s,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mm="firebase-heartbeat-database",gm=1,wr="firebase-heartbeat-store";let ya=null;function Td(){return ya||(ya=Lp(mm,gm,{upgrade:(i,t)=>{switch(t){case 0:try{i.createObjectStore(wr)}catch(e){console.warn(e)}}}}).catch(i=>{throw ic.create("idb-open",{originalErrorMessage:i.message})})),ya}async function _m(i){try{const e=(await Td()).transaction(wr),n=await e.objectStore(wr).get(Ad(i));return await e.done,n}catch(t){if(t instanceof wi)si.warn(t.message);else{const e=ic.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});si.warn(e.message)}}}async function dh(i,t){try{const n=(await Td()).transaction(wr,"readwrite");await n.objectStore(wr).put(t,Ad(i)),await n.done}catch(e){if(e instanceof wi)si.warn(e.message);else{const n=ic.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});si.warn(n.message)}}}function Ad(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vm=1024,ym=30;class xm{constructor(t){this.container=t,this._heartbeatsCache=null;const e=this.container.getProvider("app").getImmediate();this._storage=new Sm(e),this._heartbeatsCachePromise=this._storage.read().then(n=>(this._heartbeatsCache=n,n))}async triggerHeartbeat(){var t,e;try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=fh();if(((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(a=>a.date===r))return;if(this._heartbeatsCache.heartbeats.push({date:r,agent:s}),this._heartbeatsCache.heartbeats.length>ym){const a=Em(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(a,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(n){si.warn(n)}}async getHeartbeatsHeader(){var t;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=fh(),{heartbeatsToSend:n,unsentEntries:s}=Mm(this._heartbeatsCache.heartbeats),r=xd(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(e){return si.warn(e),""}}}function fh(){return new Date().toISOString().substring(0,10)}function Mm(i,t=vm){const e=[];let n=i.slice();for(const s of i){const r=e.find(a=>a.agent===s.agent);if(r){if(r.dates.push(s.date),ph(e)>t){r.dates.pop();break}}else if(e.push({agent:s.agent,dates:[s.date]}),ph(e)>t){e.pop();break}n=n.slice(1)}return{heartbeatsToSend:e,unsentEntries:n}}class Sm{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return fp()?pp().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const e=await _m(this.app);return e!=null&&e.heartbeats?e:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){var e;if(await this._canUseIndexedDBPromise){const s=await this.read();return dh(this.app,{lastSentHeartbeatDate:(e=t.lastSentHeartbeatDate)!==null&&e!==void 0?e:s.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){var e;if(await this._canUseIndexedDBPromise){const s=await this.read();return dh(this.app,{lastSentHeartbeatDate:(e=t.lastSentHeartbeatDate)!==null&&e!==void 0?e:s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...t.heartbeats]})}else return}}function ph(i){return xd(JSON.stringify({version:2,heartbeats:i})).length}function Em(i){if(i.length===0)return-1;let t=0,e=i[0].date;for(let n=1;n<i.length;n++)i[n].date<e&&(e=i[n].date,t=n);return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bm(i){Ns(new Us("platform-logger",t=>new Op(t),"PRIVATE")),Ns(new Us("heartbeat",t=>new xm(t),"PRIVATE")),Si(ol,ch,i),Si(ol,ch,"esm2017"),Si("fire-js","")}bm("");var wm="firebase",Tm="11.10.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Si(wm,Tm,"app");function Cd(i,t){var e={};for(var n in i)Object.prototype.hasOwnProperty.call(i,n)&&t.indexOf(n)<0&&(e[n]=i[n]);if(i!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,n=Object.getOwnPropertySymbols(i);s<n.length;s++)t.indexOf(n[s])<0&&Object.prototype.propertyIsEnumerable.call(i,n[s])&&(e[n[s]]=i[n[s]]);return e}function Rd(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Am=Rd,Pd=new Rr("auth","Firebase",Rd());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ko=new ec("@firebase/auth");function Cm(i,...t){ko.logLevel<=de.WARN&&ko.warn(`Auth (${Zo}): ${i}`,...t)}function Co(i,...t){ko.logLevel<=de.ERROR&&ko.error(`Auth (${Zo}): ${i}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mh(i,...t){throw sc(i,...t)}function Id(i,...t){return sc(i,...t)}function Dd(i,t,e){const n=Object.assign(Object.assign({},Am()),{[t]:e});return new Rr("auth","Firebase",n).create(t,{appName:i.name})}function Ro(i){return Dd(i,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function sc(i,...t){if(typeof i!="string"){const e=t[0],n=[...t.slice(1)];return n[0]&&(n[0].appName=i.name),i._errorFactory.create(e,...n)}return Pd.create(i,...t)}function se(i,t,...e){if(!i)throw sc(t,...e)}function vr(i){const t="INTERNAL ASSERTION FAILED: "+i;throw Co(t),new Error(t)}function zo(i,t){i||vr(t)}function Rm(){return gh()==="http:"||gh()==="https:"}function gh(){var i;return typeof self<"u"&&((i=self.location)===null||i===void 0?void 0:i.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pm(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Rm()||up()||"connection"in navigator)?navigator.onLine:!0}function Im(){if(typeof navigator>"u")return null;const i=navigator;return i.languages&&i.languages[0]||i.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pr{constructor(t,e){this.shortDelay=t,this.longDelay=e,zo(e>t,"Short delay should be less than long delay!"),this.isMobile=cp()||dp()}get(){return Pm()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dm(i,t){zo(i.emulator,"Emulator should always be set here");const{url:e}=i.emulator;return t?`${e}${t.startsWith("/")?t.slice(1):t}`:e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ld{static initialize(t,e,n){this.fetchImpl=t,e&&(this.headersImpl=e),n&&(this.responseImpl=n)}static fetch(){if(this.fetchImpl)return this.fetchImpl;if(typeof self<"u"&&"fetch"in self)return self.fetch;if(typeof globalThis<"u"&&globalThis.fetch)return globalThis.fetch;if(typeof fetch<"u")return fetch;vr("Could not find fetch implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")}static headers(){if(this.headersImpl)return this.headersImpl;if(typeof self<"u"&&"Headers"in self)return self.Headers;if(typeof globalThis<"u"&&globalThis.Headers)return globalThis.Headers;if(typeof Headers<"u")return Headers;vr("Could not find Headers implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")}static response(){if(this.responseImpl)return this.responseImpl;if(typeof self<"u"&&"Response"in self)return self.Response;if(typeof globalThis<"u"&&globalThis.Response)return globalThis.Response;if(typeof Response<"u")return Response;vr("Could not find Response implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Um=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],Nm=new Pr(3e4,6e4);function Ud(i,t){return i.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:i.tenantId}):t}async function Qo(i,t,e,n,s={}){return Nd(i,s,async()=>{let r={},a={};n&&(t==="GET"?a=n:r={body:JSON.stringify(n)});const l=Ed(Object.assign({key:i.config.apiKey},a)).slice(1),c=await i._getAdditionalHeaders();c["Content-Type"]="application/json",i.languageCode&&(c["X-Firebase-Locale"]=i.languageCode);const h=Object.assign({method:t,headers:c},r);return hp()||(h.referrerPolicy="no-referrer"),i.emulatorConfig&&Sd(i.emulatorConfig.host)&&(h.credentials="include"),Ld.fetch()(await Od(i,i.config.apiHost,e,l),h)})}async function Nd(i,t,e){i._canInitEmulator=!1;const n=Object.assign(Object.assign({},Lm),t);try{const s=new Om(i),r=await Promise.race([e(),s.promise]);s.clearNetworkTimeout();const a=await r.json();if("needConfirmation"in a)throw jr(i,"account-exists-with-different-credential",a);if(r.ok&&!("errorMessage"in a))return a;{const l=r.ok?a.errorMessage:a.error.message,[c,h]=l.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw jr(i,"credential-already-in-use",a);if(c==="EMAIL_EXISTS")throw jr(i,"email-already-in-use",a);if(c==="USER_DISABLED")throw jr(i,"user-disabled",a);const d=n[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(h)throw Dd(i,d,h);mh(i,d)}}catch(s){if(s instanceof wi)throw s;mh(i,"network-request-failed",{message:String(s)})}}async function Od(i,t,e,n){const s=`${t}${e}?${n}`,r=i,a=r.config.emulator?Dm(i.config,s):`${i.config.apiScheme}://${s}`;return Um.includes(e)&&(await r._persistenceManagerAvailable,r._getPersistenceType()==="COOKIE")?r._getPersistence()._getFinalTarget(a).toString():a}class Om{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(t){this.auth=t,this.timer=null,this.promise=new Promise((e,n)=>{this.timer=setTimeout(()=>n(Id(this.auth,"network-request-failed")),Nm.get())})}}function jr(i,t,e){const n={appName:i.name};e.email&&(n.email=e.email),e.phoneNumber&&(n.phoneNumber=e.phoneNumber);const s=Id(i,t,n);return s.customData._tokenResponse=e,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fm(i,t){return Qo(i,"POST","/v1/accounts:delete",t)}async function Vo(i,t){return Qo(i,"POST","/v1/accounts:lookup",t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yr(i){if(i)try{const t=new Date(Number(i));if(!isNaN(t.getTime()))return t.toUTCString()}catch{}}async function Bm(i,t=!1){const e=Jo(i),n=await e.getIdToken(t),s=Fd(n);se(s&&s.exp&&s.auth_time&&s.iat,e.auth,"internal-error");const r=typeof s.firebase=="object"?s.firebase:void 0,a=r==null?void 0:r.sign_in_provider;return{claims:s,token:n,authTime:yr(xa(s.auth_time)),issuedAtTime:yr(xa(s.iat)),expirationTime:yr(xa(s.exp)),signInProvider:a||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function xa(i){return Number(i)*1e3}function Fd(i){const[t,e,n]=i.split(".");if(t===void 0||e===void 0||n===void 0)return Co("JWT malformed, contained fewer than 3 sections"),null;try{const s=Md(e);return s?JSON.parse(s):(Co("Failed to decode base64 JWT payload"),null)}catch(s){return Co("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function _h(i){const t=Fd(i);return se(t,"internal-error"),se(typeof t.exp<"u","internal-error"),se(typeof t.iat<"u","internal-error"),Number(t.exp)-Number(t.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function al(i,t,e=!1){if(e)return t;try{return await t}catch(n){throw n instanceof wi&&km(n)&&i.auth.currentUser===i&&await i.auth.signOut(),n}}function km({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Go(i){var t;const e=i.auth,n=await i.getIdToken(),s=await al(i,Vo(e,{idToken:n}));se(s==null?void 0:s.users.length,e,"internal-error");const r=s.users[0];i._notifyReloadListener(r);const a=!((t=r.providerUserInfo)===null||t===void 0)&&t.length?Bd(r.providerUserInfo):[],l=Gm(i.providerData,a),c=i.isAnonymous,h=!(i.email&&r.passwordHash)&&!(l!=null&&l.length),d=c?h:!1,p={uid:r.localId,displayName:r.displayName||null,photoURL:r.photoUrl||null,email:r.email||null,emailVerified:r.emailVerified||!1,phoneNumber:r.phoneNumber||null,tenantId:r.tenantId||null,providerData:l,metadata:new ll(r.createdAt,r.lastLoginAt),isAnonymous:d};Object.assign(i,p)}async function Vm(i){const t=Jo(i);await Go(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}function Gm(i,t){return[...i.filter(n=>!t.some(s=>s.providerId===n.providerId)),...t]}function Bd(i){return i.map(t=>{var{providerId:e}=t,n=Cd(t,["providerId"]);return{providerId:e,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hm(i,t){const e=await Nd(i,{},async()=>{const n=Ed({grant_type:"refresh_token",refresh_token:t}).slice(1),{tokenApiHost:s,apiKey:r}=i.config,a=await Od(i,s,"/v1/token",`key=${r}`),l=await i._getAdditionalHeaders();l["Content-Type"]="application/x-www-form-urlencoded";const c={method:"POST",headers:l,body:n};return i.emulatorConfig&&Sd(i.emulatorConfig.host)&&(c.credentials="include"),Ld.fetch()(a,c)});return{accessToken:e.access_token,expiresIn:e.expires_in,refreshToken:e.refresh_token}}async function Wm(i,t){return Qo(i,"POST","/v2/accounts:revokeToken",Ud(i,t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cs{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(t){se(t.idToken,"internal-error"),se(typeof t.idToken<"u","internal-error"),se(typeof t.refreshToken<"u","internal-error");const e="expiresIn"in t&&typeof t.expiresIn<"u"?Number(t.expiresIn):_h(t.idToken);this.updateTokensAndExpiration(t.idToken,t.refreshToken,e)}updateFromIdToken(t){se(t.length!==0,"internal-error");const e=_h(t);this.updateTokensAndExpiration(t,null,e)}async getToken(t,e=!1){return!e&&this.accessToken&&!this.isExpired?this.accessToken:(se(this.refreshToken,t,"user-token-expired"),this.refreshToken?(await this.refresh(t,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(t,e){const{accessToken:n,refreshToken:s,expiresIn:r}=await Hm(t,e);this.updateTokensAndExpiration(n,s,Number(r))}updateTokensAndExpiration(t,e,n){this.refreshToken=e||null,this.accessToken=t||null,this.expirationTime=Date.now()+n*1e3}static fromJSON(t,e){const{refreshToken:n,accessToken:s,expirationTime:r}=e,a=new Cs;return n&&(se(typeof n=="string","internal-error",{appName:t}),a.refreshToken=n),s&&(se(typeof s=="string","internal-error",{appName:t}),a.accessToken=s),r&&(se(typeof r=="number","internal-error",{appName:t}),a.expirationTime=r),a}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(t){this.accessToken=t.accessToken,this.refreshToken=t.refreshToken,this.expirationTime=t.expirationTime}_clone(){return Object.assign(new Cs,this.toJSON())}_performRefresh(){return vr("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vh=new Map;function Gi(i){zo(i instanceof Function,"Expected a class definition");let t=vh.get(i);return t?(zo(t instanceof i,"Instance stored in cache mismatched with class"),t):(t=new i,vh.set(i,t),t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kd{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(t,e){this.storage[t]=e}async _get(t){const e=this.storage[t];return e===void 0?null:e}async _remove(t){delete this.storage[t]}_addListener(t,e){}_removeListener(t,e){}}kd.type="NONE";const yh=kd;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ma(i,t,e){return`firebase:${i}:${t}:${e}`}class Rs{constructor(t,e,n){this.persistence=t,this.auth=e,this.userKey=n;const{config:s,name:r}=this.auth;this.fullUserKey=Ma(this.userKey,s.apiKey,r),this.fullPersistenceKey=Ma("persistence",s.apiKey,r),this.boundEventHandler=e._onStorageEvent.bind(e),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(t){return this.persistence._set(this.fullUserKey,t.toJSON())}async getCurrentUser(){const t=await this.persistence._get(this.fullUserKey);if(!t)return null;if(typeof t=="string"){const e=await Vo(this.auth,{idToken:t}).catch(()=>{});return e?Fn._fromGetAccountInfoResponse(this.auth,e,t):null}return Fn._fromJSON(this.auth,t)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(t){if(this.persistence===t)return;const e=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=t,e)return this.setCurrentUser(e)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(t,e,n="authUser"){if(!e.length)return new Rs(Gi(yh),t,n);const s=(await Promise.all(e.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let r=s[0]||Gi(yh);const a=Ma(n,t.config.apiKey,t.name);let l=null;for(const h of e)try{const d=await h._get(a);if(d){let p;if(typeof d=="string"){const m=await Vo(t,{idToken:d}).catch(()=>{});if(!m)break;p=await Fn._fromGetAccountInfoResponse(t,m,d)}else p=Fn._fromJSON(t,d);h!==r&&(l=p),r=h;break}}catch{}const c=s.filter(h=>h._shouldAllowMigration);return!r._shouldAllowMigration||!c.length?new Rs(r,t,n):(r=c[0],l&&await r._set(a,l.toJSON()),await Promise.all(e.map(async h=>{if(h!==r)try{await h._remove(a)}catch{}})),new Rs(r,t,n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xh(i){const t=i.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if($m(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Xm(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Km(t))return"Blackberry";if(Jm(t))return"Webos";if(qm(t))return"Safari";if((t.includes("chrome/")||jm(t))&&!t.includes("edge/"))return"Chrome";if(Ym(t))return"Android";{const e=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=i.match(e);if((n==null?void 0:n.length)===2)return n[1]}return"Other"}function Xm(i=zn()){return/firefox\//i.test(i)}function qm(i=zn()){const t=i.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function jm(i=zn()){return/crios\//i.test(i)}function $m(i=zn()){return/iemobile/i.test(i)}function Ym(i=zn()){return/android/i.test(i)}function Km(i=zn()){return/blackberry/i.test(i)}function Jm(i=zn()){return/webos/i.test(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zd(i,t=[]){let e;switch(i){case"Browser":e=xh(zn());break;case"Worker":e=`${xh(zn())}-${i}`;break;default:e=i}const n=t.length?t.join(","):"FirebaseCore-web";return`${e}/JsCore/${Zo}/${n}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qm(i,t={}){return Qo(i,"GET","/v2/passwordPolicy",Ud(i,t))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new Pr(5e3,15e3);var Sh="@firebase/auth",Eh="1.10.8";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function og(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function ag(i){Ns(new Us("auth",(t,{options:e})=>{const n=t.getProvider("app").getImmediate(),s=t.getProvider("heartbeat"),r=t.getProvider("app-check-internal"),{apiKey:a,authDomain:l}=n.options;se(a&&!a.includes(":"),"invalid-api-key",{appName:n.name});const c={apiKey:a,authDomain:l,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:zd(i)},h=new ng(n,s,r,c);return sg(h,e),h},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,e,n)=>{t.getProvider("auth-internal").initialize()})),Ns(new Us("auth-internal",t=>{const e=ig(t.getProvider("auth").getImmediate());return(n=>new rg(n))(e)},"PRIVATE").setInstantiationMode("EXPLICIT")),Si(Sh,Eh,og(i)),Si(Sh,Eh,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ho=new ec("@firebase/firestore");function Tn(i,...t){if(Ho.logLevel<=de.DEBUG){const e=t.map(Gd);Ho.debug(`Firestore (${ta}): ${i}`,...e)}}function Vd(i,...t){if(Ho.logLevel<=de.ERROR){const e=t.map(Gd);Ho.error(`Firestore (${ta}): ${i}`,...e)}}function Gd(i){if(typeof i=="string")return i;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wo(i,t,e){let n="Unexpected state";typeof t=="string"?n=t:e=t,Hd(i,n,e)}function Hd(i,t,e){let n=`FIRESTORE (${ta}) INTERNAL ASSERTION FAILED: ${t} (ID: ${i.toString(16)})`;if(e!==void 0)try{n+=" CONTEXT: "+JSON.stringify(e)}catch{n+=" CONTEXT: "+e}throw Vd(n),new Error(n)}function xr(i,t,e,n){let s="Unexpected state";typeof e=="string"?s=e:n=e,i||Hd(t,s,n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cg{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class hg{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable((()=>e(an.UNAUTHENTICATED)))}shutdown(){}}class ug{constructor(t){this.t=t,this.currentUser=an.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){xr(this.o===void 0,42304);let n=this.i;const s=c=>this.i!==n?(n=this.i,e(c)):Promise.resolve();let r=new Mr;this.o=()=>{this.i++,this.currentUser=this.u(),r.resolve(),r=new Mr,t.enqueueRetryable((()=>s(this.currentUser)))};const a=()=>{const c=r;t.enqueueRetryable((async()=>{await c.promise,await s(this.currentUser)}))},l=c=>{Tn("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=c,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit((c=>l(c))),setTimeout((()=>{if(!this.auth){const c=this.t.getImmediate({optional:!0});c?l(c):(Tn("FirebaseAuthCredentialsProvider","Auth not yet detected"),r.resolve(),r=new Mr)}}),0),a()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then((n=>this.i!==t?(Tn("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):n?(xr(typeof n.accessToken=="string",31837,{l:n}),new cg(n.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return xr(t===null||typeof t=="string",2055,{h:t}),new an(t)}}class dg{constructor(t,e,n){this.P=t,this.T=e,this.I=n,this.type="FirstParty",this.user=an.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const t=this.R();return t&&this.A.set("Authorization",t),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class fg{constructor(t,e,n){this.P=t,this.T=e,this.I=n}getToken(){return Promise.resolve(new dg(this.P,this.T,this.I))}start(t,e){t.enqueueRetryable((()=>e(an.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class Ah{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class pg{constructor(t,e){this.V=e,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Bi(t)&&t.settings.appCheckToken&&(this.p=t.settings.appCheckToken)}start(t,e){xr(this.o===void 0,3512);const n=r=>{r.error!=null&&Tn("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${r.error.message}`);const a=r.token!==this.m;return this.m=r.token,Tn("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?e(r.token):Promise.resolve()};this.o=r=>{t.enqueueRetryable((()=>n(r)))};const s=r=>{Tn("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=r,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit((r=>s(r))),setTimeout((()=>{if(!this.appCheck){const r=this.V.getImmediate({optional:!0});r?s(r):Tn("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){if(this.p)return Promise.resolve(new Ah(this.p));const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then((e=>e?(xr(typeof e.token=="string",44558,{tokenResult:e}),this.m=e.token,new Ah(e.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mg(i){const t=typeof self<"u"&&(self.crypto||self.msCrypto),e=new Uint8Array(i);if(t&&typeof t.getRandomValues=="function")t.getRandomValues(e);else for(let n=0;n<i;n++)e[n]=Math.floor(256*Math.random());return e}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _g{static newId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=62*Math.floor(4.129032258064516);let n="";for(;n.length<20;){const s=mg(40);for(let r=0;r<s.length;++r)n.length<20&&s[r]<e&&(n+=t.charAt(s[r]%62))}return n}}function Cn(i,t){return i<t?-1:i>t?1:0}function vg(i,t){let e=0;for(;e<i.length&&e<t.length;){const n=i.codePointAt(e),s=t.codePointAt(e);if(n!==s){if(n<128&&s<128)return Cn(n,s);{const r=gg(),a=yg(r.encode(Ch(i,e)),r.encode(Ch(t,e)));return a!==0?a:Cn(n,s)}}e+=n>65535?2:1}return Cn(i.length,t.length)}function Ch(i,t){return i.codePointAt(t)>65535?i.substring(t,t+2):i.substring(t,t+1)}function yg(i,t){for(let e=0;e<i.length&&e<t.length;++e)if(i[e]!==t[e])return Cn(i[e],t[e]);return Cn(i.length,t.length)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rh="__name__";class Un{constructor(t,e,n){e===void 0?e=0:e>t.length&&Wo(637,{offset:e,range:t.length}),n===void 0?n=t.length-e:n>t.length-e&&Wo(1746,{length:n,range:t.length-e}),this.segments=t,this.offset=e,this.len=n}get length(){return this.len}isEqual(t){return Un.comparator(this,t)===0}child(t){const e=this.segments.slice(this.offset,this.limit());return t instanceof Un?t.forEach((n=>{e.push(n)})):e.push(t),this.construct(e)}limit(){return this.offset+this.length}popFirst(t){return t=t===void 0?1:t,this.construct(this.segments,this.offset+t,this.length-t)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(t){return this.segments[this.offset+t]}isEmpty(){return this.length===0}isPrefixOf(t){if(t.length<this.length)return!1;for(let e=0;e<this.length;e++)if(this.get(e)!==t.get(e))return!1;return!0}isImmediateParentOf(t){if(this.length+1!==t.length)return!1;for(let e=0;e<this.length;e++)if(this.get(e)!==t.get(e))return!1;return!0}forEach(t){for(let e=this.offset,n=this.limit();e<n;e++)t(this.segments[e])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(t,e){const n=Math.min(t.length,e.length);for(let s=0;s<n;s++){const r=Un.compareSegments(t.get(s),e.get(s));if(r!==0)return r}return Cn(t.length,e.length)}static compareSegments(t,e){const n=Un.isNumericId(t),s=Un.isNumericId(e);return n&&!s?-1:!n&&s?1:n&&s?Un.extractNumericId(t).compare(Un.extractNumericId(e)):vg(t,e)}static isNumericId(t){return t.startsWith("__id")&&t.endsWith("__")}static extractNumericId(t){return rc.fromString(t.substring(4,t.length-2))}}class bn extends Un{construct(t,e,n){return new bn(t,e,n)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...t){const e=[];for(const n of t){if(n.indexOf("//")>=0)throw new oe(re.INVALID_ARGUMENT,`Invalid segment (${n}). Paths must not contain // in them.`);e.push(...n.split("/").filter((s=>s.length>0)))}return new bn(e)}static emptyPath(){return new bn([])}}const xg=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class ki extends Un{construct(t,e,n){return new ki(t,e,n)}static isValidIdentifier(t){return xg.test(t)}canonicalString(){return this.toArray().map((t=>(t=t.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),ki.isValidIdentifier(t)||(t="`"+t+"`"),t))).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)===Rh}static keyField(){return new ki([Rh])}static fromServerFormat(t){const e=[];let n="",s=0;const r=()=>{if(n.length===0)throw new oe(re.INVALID_ARGUMENT,`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);e.push(n),n=""};let a=!1;for(;s<t.length;){const l=t[s];if(l==="\\"){if(s+1===t.length)throw new oe(re.INVALID_ARGUMENT,"Path has trailing escape character: "+t);const c=t[s+1];if(c!=="\\"&&c!=="."&&c!=="`")throw new oe(re.INVALID_ARGUMENT,"Path has invalid escape sequence: "+t);n+=c,s+=2}else l==="`"?(a=!a,s++):l!=="."||a?(n+=l,s++):(r(),s++)}if(r(),a)throw new oe(re.INVALID_ARGUMENT,"Unterminated ` in path: "+t);return new ki(e)}static emptyPath(){return new ki([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ie(i,t){const e={typeString:i};return t&&(e.value=t),e}function Ir(i,t){if(!Sg(i))throw new oe(re.INVALID_ARGUMENT,"JSON must be an object");let e;for(const n in t)if(t[n]){const s=t[n].typeString,r="value"in t[n]?{value:t[n].value}:void 0;if(!(n in i)){e=`JSON missing required field: '${n}'`;break}const a=i[n];if(s&&typeof a!==s){e=`JSON field '${n}' must be a ${s}.`;break}if(r!==void 0&&a!==r.value){e=`Expected '${n}' field to equal '${r.value}'`;break}}if(e)throw new oe(re.INVALID_ARGUMENT,e);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yi{constructor(t){this.binaryString=t}static fromBase64String(t){const e=(function(s){try{return atob(s)}catch(r){throw typeof DOMException<"u"&&r instanceof DOMException?new bg("Invalid base64 string: "+r):r}})(t);return new Yi(e)}static fromUint8Array(t){const e=(function(s){let r="";for(let a=0;a<s.length;++a)r+=String.fromCharCode(s[a]);return r})(t);return new Yi(e)}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(e){return btoa(e)})(this.binaryString)}toUint8Array(){return(function(e){const n=new Uint8Array(e.length);for(let s=0;s<e.length;s++)n[s]=e.charCodeAt(s);return n})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return Cn(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}Yi.EMPTY_BYTE_STRING=new Yi("");const Dh="(default)";class Xo{constructor(t,e){this.projectId=t,this.database=e||Dh}static empty(){return new Xo("","")}get isDefaultDatabase(){return this.database===Dh}isEqual(t){return t instanceof Xo&&t.projectId===this.projectId&&t.database===this.database}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wg{constructor(t,e=null,n=[],s=[],r=null,a="F",l=null,c=null){this.path=t,this.collectionGroup=e,this.explicitOrderBy=n,this.filters=s,this.limit=r,this.limitType=a,this.startAt=l,this.endAt=c,this.Te=null,this.Ie=null,this.de=null,this.startAt,this.endAt}}function Tg(i){return new wg(i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Lh,te;(te=Lh||(Lh={}))[te.OK=0]="OK",te[te.CANCELLED=1]="CANCELLED",te[te.UNKNOWN=2]="UNKNOWN",te[te.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",te[te.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",te[te.NOT_FOUND=5]="NOT_FOUND",te[te.ALREADY_EXISTS=6]="ALREADY_EXISTS",te[te.PERMISSION_DENIED=7]="PERMISSION_DENIED",te[te.UNAUTHENTICATED=16]="UNAUTHENTICATED",te[te.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",te[te.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",te[te.ABORTED=10]="ABORTED",te[te.OUT_OF_RANGE=11]="OUT_OF_RANGE",te[te.UNIMPLEMENTED=12]="UNIMPLEMENTED",te[te.INTERNAL=13]="INTERNAL",te[te.UNAVAILABLE=14]="UNAVAILABLE",te[te.DATA_LOSS=15]="DATA_LOSS";/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new rc([4294967295,4294967295],0);/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cg=1048576;function Sa(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oc{constructor(t,e,n,s,r){this.asyncQueue=t,this.timerId=e,this.targetTimeMs=n,this.op=s,this.removalCallback=r,this.deferred=new Mr,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch((a=>{}))}get promise(){return this.deferred.promise}static createAndSchedule(t,e,n,s,r){const a=Date.now()+n,l=new oc(t,e,a,s,r);return l.start(n),l}start(t){this.timerHandle=setTimeout((()=>this.handleDelayElapsed()),t)}skipDelay(){return this.handleDelayElapsed()}cancel(t){this.timerHandle!==null&&(this.clearTimeout(),this.deferred.reject(new oe(re.CANCELLED,"Operation cancelled"+(t?": "+t:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget((()=>this.timerHandle!==null?(this.clearTimeout(),this.op().then((t=>this.deferred.resolve(t)))):Promise.resolve()))}clearTimeout(){this.timerHandle!==null&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}var Uh,Nh;(Nh=Uh||(Uh={})).Fa="default",Nh.Cache="cache";/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pg(i){const t={};return i.timeoutSeconds!==void 0&&(t.timeoutSeconds=i.timeoutSeconds),t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ac{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new ac(this.firestore,t,this._query)}}class Bn{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new lc(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new Bn(this.firestore,t,this._key)}toJSON(){return{type:Bn._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(t,e,n){if(Ir(e,Bn._jsonSchema))return new Bn(t,n||null,new Hi(bn.fromString(e.referencePath)))}}Bn._jsonSchemaVersion="firestore/documentReference/1.0",Bn._jsonSchema={type:Ie("string",Bn._jsonSchemaVersion),referencePath:Ie("string")};class lc extends ac{constructor(t,e,n){super(t,e,Tg(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new Bn(this.firestore,null,new Hi(t))}withConverter(t){return new lc(this.firestore,t,this._path)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kh="AsyncQueue";class zh{constructor(t=Promise.resolve()){this.Zu=[],this.Xu=!1,this.ec=[],this.tc=null,this.nc=!1,this.rc=!1,this.sc=[],this.F_=new Rg(this,"async_queue_retry"),this.oc=()=>{const n=Sa();n&&Tn(kh,"Visibility state changed to "+n.visibilityState),this.F_.y_()},this._c=t;const e=Sa();e&&typeof e.addEventListener=="function"&&e.addEventListener("visibilitychange",this.oc)}get isShuttingDown(){return this.Xu}enqueueAndForget(t){this.enqueue(t)}enqueueAndForgetEvenWhileRestricted(t){this.ac(),this.uc(t)}enterRestrictedMode(t){if(!this.Xu){this.Xu=!0,this.rc=t||!1;const e=Sa();e&&typeof e.removeEventListener=="function"&&e.removeEventListener("visibilitychange",this.oc)}}enqueue(t){if(this.ac(),this.Xu)return new Promise((()=>{}));const e=new Mr;return this.uc((()=>this.Xu&&this.rc?Promise.resolve():(t().then(e.resolve,e.reject),e.promise))).then((()=>e.promise))}enqueueRetryable(t){this.enqueueAndForget((()=>(this.Zu.push(t),this.cc())))}async cc(){if(this.Zu.length!==0){try{await this.Zu[0](),this.Zu.shift(),this.F_.reset()}catch(t){if(!Eg(t))throw t;Tn(kh,"Operation failed with retryable error: "+t)}this.Zu.length>0&&this.F_.g_((()=>this.cc()))}}uc(t){const e=this._c.then((()=>(this.nc=!0,t().catch((n=>{throw this.tc=n,this.nc=!1,Vd("INTERNAL UNHANDLED ERROR: ",Vh(n)),n})).then((n=>(this.nc=!1,n))))));return this._c=e,e}enqueueAfterDelay(t,e,n){this.ac(),this.sc.indexOf(t)>-1&&(e=0);const s=oc.createAndSchedule(this,t,e,n,(r=>this.lc(r)));return this.ec.push(s),s}ac(){this.tc&&Wo(47125,{hc:Vh(this.tc)})}verifyOperationInProgress(){}async Pc(){let t;do t=this._c,await t;while(t!==this._c)}Tc(t){for(const e of this.ec)if(e.timerId===t)return!0;return!1}Ic(t){return this.Pc().then((()=>{this.ec.sort(((e,n)=>e.targetTimeMs-n.targetTimeMs));for(const e of this.ec)if(e.skipDelay(),t!=="all"&&e.timerId===t)break;return this.Pc()}))}dc(t){this.sc.push(t)}lc(t){const e=this.ec.indexOf(t);this.ec.splice(e,1)}}function Vh(i){let t=i.message||"";return i.stack&&(t=i.stack.includes(i.message)?i.stack:i.message+`
`+i.stack),t}class Lg extends Dg{constructor(t,e,n,s){super(t,e,n,s),this.type="firestore",this._queue=new zh,this._persistenceKey=(s==null?void 0:s.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new zh(t),this._firestoreClient=void 0,await t}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wd{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new oe(re.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ki(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ti,depthTest:!1,depthWrite:!1})}function Mu(){return new we({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ec(),fragmentShader:`
		...
		`,blending:ti,depthTest:!1,depthWrite:!1})}function Su(){return new we({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ec(),fragmentShader:`
	...
	`}function tx(i){let t=new WeakMap,e=null;function n(l){if(l&&l.isTexture){const c=l.mapping,h=c===vl||c===yl,d=c===Fs||c===Bs;if(h||d){let p=t.get(l);const m=p!==void 0?p.texture.pmremVersion:0;if(l.isRenderTargetTexture&&l.pmremVersion!==m)return e===null&&(e=new yu(i)),p=h?e.fromEquirectangular(l,p):e.fromCubemap(l,p),p.texture.pmremVersion=l.pmremVersion,t.set(l,p),p.texture;if(p!==void 0)return p.texture;{const y=l.image;return h&&y&&y.height>0||d&&y&&s(y)?(e===null&&(e=new yu(i)),p=h?e.fromEquirectangular(l):e.fromCubemap(l),p.texture.pmremVersion=l.pmremVersion,t.set(l,p),l.addEventListener("dispose",r),p.texture):null}}}return l}function s(l){let c=0;const h=6;for(let d=0;d<h;d++)l[d]!==void 0&&c++;return c===h}function r(l){const c=l.target;c.removeEventListener("dispose",r);const h=t.get(c);h!==void 0&&(t.delete(c),h.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function ex(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&mr("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function nx(i,t,e,n){const s={},r=new WeakMap;function a(p){const m=p.target;m.index!==null&&t.remove(m.index);for(const M in m.attributes)t.remove(m.attributes[M]);for(const M in m.morphAttributes){const b=m.morphAttributes[M];for(let v=0,f=b.length;v<f;v++)t.remove(b[v])}m.removeEventListener("dispose",a),delete s[m.id];const y=r.get(m);y&&(t.remove(y),r.delete(m)),n.releaseStatesOfGeometry(m),m.isInstancedBufferGeometry===!0&&delete m._maxInstanceCount,e.memory.geometries--}function l(p,m){return s[m.id]===!0||(m.addEventListener("dispose",a),s[m.id]=!0,e.memory.geometries++),m}function c(p){const m=p.attributes;for(const M in m)t.update(m[M],i.ARRAY_BUFFER);const y=p.morphAttributes;for(const M in y){const b=y[M];for(let v=0,f=b.length;v<f;v++)t.update(b[v],i.ARRAY_BUFFER)}}function h(p){const m=[],y=p.index,M=p.attributes.position;let b=0;if(y!==null){const D=y.array;b=y.version;for(let I=0,C=D.length;I<C;I+=3){const z=D[I+0],N=D[I+1],E=D[I+2];m.push(z,N,N,E,E,z)}}else if(M!==void 0){const D=M.array;b=M.version;for(let I=0,C=D.length/3-1;I<C;I+=3){const z=I+0,N=I+1,E=I+2;m.push(z,N,N,E,E,z)}}else return;const v=new(pf(m)?yf:vf)(m,1);v.version=b;const f=r.get(p);f&&t.remove(f),r.set(p,v)}function d(p){const m=r.get(p);if(m){const y=p.index;y!==null&&m.version<y.version&&h(p)}else h(p);return r.get(p)}return{get:l,update:c,getWireframeAttribute:d}}function ix(i,t,e){let n;function s(m){n=m}let r,a;function l(m){r=m.type,a=m.bytesPerElement}function c(m,y){i.drawElements(n,y,r,m*a),e.update(y,n,1)}function h(m,y,M){M!==0&&(i.drawElementsInstanced(n,y,r,m*a,M),e.update(y,n,M))}function d(m,y,M){if(M===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,y,0,r,m,0,M);let v=0;for(let f=0;f<M;f++)v+=y[f];e.update(v,n,1)}function p(m,y,M,b){if(M===0)return;const v=t.get("WEBGL_multi_draw");if(v===null)for(let f=0;f<m.length;f++)h(m[f]/a,y[f],b[f]);else{v.multiDrawElementsInstancedWEBGL(n,y,0,r,m,0,b,0,M);let f=0;for(let D=0;D<M;D++)f+=y[D]*b[D];e.update(f,n,1)}}this.setMode=s,this.setIndex=l,this.render=c,this.renderInstances=h,this.renderMultiDraw=d,this.renderMultiDrawInstances=p}function sx(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,l){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=l*(r/3);break;case i.LINES:e.lines+=l*(r/2);break;case i.LINE_STRIP:e.lines+=l*(r-1);break;case i.LINE_LOOP:e.lines+=l*r;break;case i.POINTS:e.points+=l*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function rx(i,t,e){const n=new WeakMap,s=new ve;function r(a,l,c){const h=a.morphTargetInfluences,d=l.morphAttributes.position||l.morphAttributes.normal||l.morphAttributes.color,p=d!==void 0?d.length:0;let m=n.get(l);if(m===void 0||m.count!==p){let _=function(){S.dispose(),n.delete(l),l.removeEventListener("dispose",_)};var y=_;m!==void 0&&m.texture.dispose();const M=l.morphAttributes.position!==void 0,b=l.morphAttributes.normal!==void 0,v=l.morphAttributes.color!==void 0,f=l.morphAttributes.position||[],D=l.morphAttributes.normal||[],I=l.morphAttributes.color||[];let C=0;M===!0&&(C=1),b===!0&&(C=2),v===!0&&(C=3);let z=l.attributes.position.count*C,N=1;z>t.maxTextureSize&&(N=Math.ceil(z/t.maxTextureSize),z=t.maxTextureSize);const E=new Float32Array(z*N*4*p),S=new gf(E,z,N,p);S.type=kn,S.needsUpdate=!0;const g=C*4;for(let w=0;w<p;w++){const L=f[w],T=D[w],K=I[w],Q=z*N*4*w;for(let J=0;J<L.count;J++){const nt=J*g;M===!0&&(s.fromBufferAttribute(L,J),E[Q+nt+0]=s.x,E[Q+nt+1]=s.y,E[Q+nt+2]=s.z,E[Q+nt+3]=0),b===!0&&(s.fromBufferAttribute(T,J),E[Q+nt+4]=s.x,E[Q+nt+5]=s.y,E[Q+nt+6]=s.z,E[Q+nt+7]=0),v===!0&&(s.fromBufferAttribute(K,J),E[Q+nt+8]=s.x,E[Q+nt+9]=s.y,E[Q+nt+10]=s.z,E[Q+nt+11]=K.itemSize===4?s.w:1)}}m={count:p,texture:S,size:new Mt(z,N)},n.set(l,m),l.addEventListener("dispose",_)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let M=0;for(let v=0;v<h.length;v++)M+=h[v];const b=l.morphTargetsRelative?1:1-M;c.getUniforms().setValue(i,"morphTargetBaseInfluence",b),c.getUniforms().setValue(i,"morphTargetInfluences",h)}c.getUniforms().setValue(i,"morphTargetsTexture",m.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",m.size)}return{update:r}}function ox(i,t,e,n){let s=new WeakMap;function r(c){const h=n.render.frame,d=c.geometry,p=t.get(c,d);if(s.get(p)!==h&&(t.update(p),s.set(p,h)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==h&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,h))),c.isSkinnedMesh){const m=c.skeleton;s.get(m)!==h&&(m.update(),s.set(m,h))}return p}function a(){s=new WeakMap}function l(c){const h=c.target;h.removeEventListener("dispose",l),e.remove(h.instanceMatrix),h.instanceColor!==null&&e.remove(h.instanceColor)}return{update:r,dispose:a}}class Ef extends $e{constructor(t,e,n,s,r,a,l,c,h,d=Ds){if(d!==Ds&&d!==zs)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&d===Ds&&(n=Ki),n===void 0&&d===zs&&(n=ks),super(null,s,r,a,l,c,d,n,h),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=l!==void 0?l:hn,this.minFilter=c!==void 0?c:hn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const bf=new $e,Eu=new Ef(1,1),wf=new gf,Tf=new j0,Af=new xc,bu=[],wu=[],Tu=new Float32Array(16),Au=new Float32Array(9),Cu=new Float32Array(4);function js(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=bu[s];if(r===void 0&&(r=new Float32Array(s),bu[s]=r),t!==0){n.toArray(r,0);for(let a=1,l=0;a!==t;++a)l+=e,i[a].toArray(r,l)}return r}function Ue(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function Ne(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function ra(i,t){let e=wu[t];e===void 0&&(e=new Int32Array(t),wu[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function ax(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function lx(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ue(e,t))return;i.uniform2fv(this.addr,t),Ne(e,t)}}function cx(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Ue(e,t))return;i.uniform3fv(this.addr,t),Ne(e,t)}}function hx(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ue(e,t))return;i.uniform4fv(this.addr,t),Ne(e,t)}}function ux(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ue(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),Ne(e,t)}else{if(Ue(e,n))return;Cu.set(n),i.uniformMatrix2fv(this.addr,!1,Cu),Ne(e,n)}}function dx(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ue(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),Ne(e,t)}else{if(Ue(e,n))return;Au.set(n),i.uniformMatrix3fv(this.addr,!1,Au),Ne(e,n)}}function fx(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ue(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),Ne(e,t)}else{if(Ue(e,n))return;Tu.set(n),i.uniformMatrix4fv(this.addr,!1,Tu),Ne(e,n)}}function px(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function mx(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ue(e,t))return;i.uniform2iv(this.addr,t),Ne(e,t)}}function gx(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ue(e,t))return;i.uniform3iv(this.addr,t),Ne(e,t)}}function _x(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ue(e,t))return;i.uniform4iv(this.addr,t),Ne(e,t)}}function vx(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function yx(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ue(e,t))return;i.uniform2uiv(this.addr,t),Ne(e,t)}}function xx(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ue(e,t))return;i.uniform3uiv(this.addr,t),Ne(e,t)}}function Mx(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ue(e,t))return;i.uniform4uiv(this.addr,t),Ne(e,t)}}function Sx(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Eu.compareFunction=ff,r=Eu):r=bf,e.setTexture2D(t||r,s)}function Ex(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||Tf,s)}function bx(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||Af,s)}function wx(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||wf,s)}function Tx(i){switch(i){case 5126:return ax;case 35664:return lx;case 35665:return cx;case 35666:return hx;case 35674:return ux;case 35675:return dx;case 35676:return fx;case 5124:case 35670:return px;case 35667:case 35671:return mx;case 35668:case 35672:return gx;case 35669:case 35673:return _x;case 5125:return vx;case 36294:return yx;case 36295:return xx;case 36296:return Mx;case 35678:case 36198:case 36298:case 36306:case 35682:return Sx;case 35679:case 36299:case 36307:return Ex;case 35680:case 36300:case 36308:case 36293:return bx;case 36289:case 36303:case 36311:case 36292:return wx}}function Ax(i,t){i.uniform1fv(this.addr,t)}function Cx(i,t){const e=js(t,this.size,2);i.uniform2fv(this.addr,e)}function Rx(i,t){const e=js(t,this.size,3);i.uniform3fv(this.addr,e)}function Px(i,t){const e=js(t,this.size,4);i.uniform4fv(this.addr,e)}function Ix(i,t){const e=js(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function Dx(i,t){const e=js(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Lx(i,t){const e=js(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Ux(i,t){i.uniform1iv(this.addr,t)}function Nx(i,t){i.uniform2iv(this.addr,t)}function Ox(i,t){i.uniform3iv(this.addr,t)}function Fx(i,t){i.uniform4iv(this.addr,t)}function Bx(i,t){i.uniform1uiv(this.addr,t)}function kx(i,t){i.uniform2uiv(this.addr,t)}function zx(i,t){i.uniform3uiv(this.addr,t)}function Vx(i,t){i.uniform4uiv(this.addr,t)}function Gx(i,t,e){const n=this.cache,s=t.length,r=ra(e,s);Ue(n,r)||(i.uniform1iv(this.addr,r),Ne(n,r));for(let a=0;a!==s;++a)e.setTexture2D(t[a]||bf,r[a])}function Hx(i,t,e){const n=this.cache,s=t.length,r=ra(e,s);Ue(n,r)||(i.uniform1iv(this.addr,r),Ne(n,r));for(let a=0;a!==s;++a)e.setTexture3D(t[a]||Tf,r[a])}function Wx(i,t,e){const n=this.cache,s=t.length,r=ra(e,s);Ue(n,r)||(i.uniform1iv(this.addr,r),Ne(n,r));for(let a=0;a!==s;++a)e.setTextureCube(t[a]||Af,r[a])}function Xx(i,t,e){const n=this.cache,s=t.length,r=ra(e,s);Ue(n,r)||(i.uniform1iv(this.addr,r),Ne(n,r));for(let a=0;a!==s;++a)e.setTexture2DArray(t[a]||wf,r[a])}function qx(i){switch(i){case 5126:return Ax;case 35664:return Cx;case 35665:return Rx;case 35666:return Px;case 35674:return Ix;case 35675:return Dx;case 35676:return Lx;case 5124:case 35670:return Ux;case 35667:case 35671:return Nx;case 35668:case 35672:return Ox;case 35669:case 35673:return Fx;case 5125:return Bx;case 36294:return kx;case 36295:return zx;case 36296:return Vx;case 35678:case 36198:case 36298:case 36306:case 35682:return Gx;case 35679:case 36299:case 36307:return Hx;case 35680:case 36300:case 36308:case 36293:return Wx;case 36289:case 36303:case 36311:case 36292:return Xx}}class jx{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Tx(e.type)}}class $x{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=qx(e.type)}}class Yx{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const l=s[r];l.setValue(t,e[l.id],n)}}}const Ya=/(\w+)(\])?(\[|\.)?/g;function Ru(i,t){i.seq.push(t),i.map[t.id]=t}function Kx(i,t,e){const n=i.name,s=n.length;for(Ya.lastIndex=0;;){const r=Ya.exec(n),a=Ya.lastIndex;let l=r[1];const c=r[2]==="]",h=r[3];if(c&&(l=l|0),h===void 0||h==="["&&a+2===s){Ru(e,h===void 0?new jx(l,i,t):new $x(l,i,t));break}else{let p=e.map[l];p===void 0&&(p=new Yx(l),Ru(e,p)),e=p}}}class Oo{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=t.getActiveUniform(e,s),a=t.getUniformLocation(e,r.name);Kx(r,a,this)}}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,a=e.length;r!==a;++r){const l=e[r],c=n[l.id];c.needsUpdate!==!1&&l.setValue(t,c.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const a=t[s];a.id in e&&n.push(a)}return n}}function Pu(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const Jx=37297;let Zx=0;function Qx(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let a=s;a<r;a++){const l=a+1;n.push(`${l===t?">":" "} ${l}: ${e[a]}`)}return n.join(`
`)}const Iu=new Wt;function tM(i){ee._getMatrix(Iu,ee.workingColorSpace,i);const t=`mat3( ${Iu.elements.map(e=>e.toFixed(4))} )`;switch(ee.getTransfer(i)){case na:return[t,"LinearTransferOETF"];case he:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function Du(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),s=i.getShaderInfoLog(t).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const a=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+Qx(i.getShaderSource(t),a)}else return s}function eM(i,t){const e=tM(t);return[`vec4 ${i}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function nM(i,t){let e;switch(t){case Kd:e="Linear";break;case Jd:e="Reinhard";break;case Zd:e="Cineon";break;case hc:e="ACESFilmic";break;case Qd:e="AgX";break;case tf:e="Neutral";break;case h0:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const _o=new O;function iM(){ee.getLuminanceCoefficients(_o);const i=_o.x.toFixed(4),t=_o.y.toFixed(4),e=_o.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function sM(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(gr).join(`
`)}function rM(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function oM(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),a=r.name;let l=1;r.type===i.FLOAT_MAT2&&(l=2),r.type===i.FLOAT_MAT3&&(l=3),r.type===i.FLOAT_MAT4&&(l=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:l}}return e}function gr(i){return i!==""}function Lu(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Uu(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const aM=/^[ \t]*#include +<([\w\d./]+)>/gm;function Yl(i){return i.replace(aM,cM)}const lM=new Map;function cM(i,t){let e=Xt[t];if(e===void 0){const n=lM.get(t);if(n!==void 0)e=Xt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Yl(e)}const hM=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Nu(i){return i.replace(hM,uM)}function uM(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ou(i){let t=`precision ${i.precision} float;
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class $s{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const MS=new Sc(-1,1,1,-1,0,1);class SS extends Re{constructor(){super(),this.setAttribute("position",new ye([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new ye([0,2,0,0,2,0],2))}}const ES=new SS;class Ic{constructor(t){this._mesh=new Ft(ES,t)}dispose(){this._mesh.geometry.dispose()}render(t){t.render(this._mesh,MS)}get material(){return this._mesh.material}set material(t){this._mesh.material=t}}class Fo extends $s{constructor(t,e){super(),this.textureID=e!==void 0?e:"tDiffuse",t instanceof we?(this.uniforms=t.uniforms,this.material=t):t&&(this.uniforms=Cr.clone(t.uniforms),this.material=new we({name:t.name!==void 0?t.name:"unspecified",defines:Object.assign({},t.defines),uniforms:this.uniforms,vertexShader:t.vertexShader,fragmentShader:t.fragmentShader})),this.fsQuad=new Ic(this.material)}render(t,e,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(t.setRenderTarget(null),this.fsQuad.render(t)):(t.setRenderTarget(e),this.clear&&t.clear(t.autoClearColor,t.autoClearDepth,t.autoClearStencil),this.fsQuad.render(t))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class sd extends $s{constructor(t,e){super(),this.scene=t,this.camera=e,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(t,e,n){const s=t.getContext(),r=t.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,l;this.inverse?(a=0,l=1):(a=1,l=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(l),r.buffers.stencil.setLocked(!0),t.setRenderTarget(n),this.clear&&t.clear(),t.render(this.scene,this.camera),t.setRenderTarget(e),this.clear&&t.clear(),t.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class bS extends $s{constructor(){super(),this.needsSwap=!1}render(t){t.state.buffers.stencil.setLocked(!1),t.state.buffers.stencil.setTest(!1)}}class wS{constructor(t,e){if(this.renderer=t,this._pixelRatio=t.getPixelRatio(),e===void 0){const n=t.getSize(new Mt);this._width=n.width,this._height=n.height,e=new Rn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:ei}),e.texture.name="EffectComposer.rt1"}else this._width=e.width,this._height=e.height;this.renderTarget1=e,this.renderTarget2=e.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Fo(Df),this.copyPass.material.blending=ti,this.clock=new cS}swapBuffers(){const t=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=t}addPass(t){this.passes.push(t),t.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(t,e){this.passes.splice(e,0,t),t.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(t){const e=this.passes.indexOf(t);e!==-1&&this.passes.splice(e,1)}isLastEnabledPass(t){for(let e=t+1;e<this.passes.length;e++)if(this.passes[e].enabled)return!1;return!0}render(t){t===void 0&&(t=this.clock.getDelta());const e=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,t,n),a.needsSwap){if(n){const l=this.renderer.getContext(),c=this.renderer.state.buffers.stencil;c.setFunc(l.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,t),c.setFunc(l.EQUAL,1,4294967295)}this.swapBuffers()}sd!==void 0&&(a instanceof sd?n=!0:a instanceof bS&&(n=!1))}}this.renderer.setRenderTarget(e)}reset(t){if(t===void 0){const e=this.renderer.getSize(new Mt);this._pixelRatio=this.renderer.getPixelRatio(),this._width=e.width,this._height=e.height,t=this.renderTarget1.clone(),t.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=t,this.renderTarget2=t.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(t,e){this._width=t,this._height=e;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(t){this._pixelRatio=t,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class rd extends $s{constructor(t,e,n=null,s=null,r=null){super(),this.scene=t,this.camera=e,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new St}render(t,e,n){const s=t.autoClear;t.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(t.getClearColor(this._oldClearColor),t.setClearColor(this.clearColor,t.getClearAlpha())),this.clearAlpha!==null&&(r=t.getClearAlpha(),t.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&t.clearDepth(),t.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&t.clear(t.autoClearColor,t.autoClearDepth,t.autoClearStencil),t.render(this.scene,this.camera),this.clearColor!==null&&t.setClearColor(this._oldClearColor),this.clearAlpha!==null&&t.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),t.autoClear=s}}const TS={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new St(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Ji.BlurDirectionX=new Mt(1,0);Ji.BlurDirectionY=new Mt(0,1);const AS={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
  ...
  `};class CS{constructor(t){this.renderer=new KM({logarithmicDepthBuffer:!0,antialias:!0,alpha:!1,powerPreference:"high-performance"}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setClearColor(658964,1),this.renderer.toneMapping=hc,this.renderer.toneMappingExposure=1.1,this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=$d,t.appendChild(this.renderer.domElement),this.composer=null,this.bloomPass=null,this.godRayPass=null,this.colorGradePass=null}setupPostProcessing(t,e){const n=new Mt(window.innerWidth,window.innerHeight);this.composer=new wS(this.renderer),this.composer.addPass(new rd(t,e)),this.bloomPass=new Ji(n,.8,.6,.55),this.composer.addPass(this.bloomPass),this.colorGradePass=new Fo(ad),this.composer.addPass(this.colorGradePass),this.composer.addPass(new od)}tick(t){}addGodRayPass(t){if(this.godRayPass)return;this.bloomPass&&this.bloomPass.dispose(),this.colorGradePass&&this.colorGradePass.dispose();const e=this.composer.passes[0].scene,n=this.composer.passes[0].camera,s=new Mt(window.innerWidth,window.innerHeight);this.composer.passes.length=0,this.composer.addPass(new rd(e,n)),this.bloomPass=new Ji(s,.8,.6,.55),this.composer.addPass(this.bloomPass),this.godRayPass=new Fo(t),this.godRayPass.uniforms.uLightPos.value=new Mt(.5,.5),this.godRayPass.uniforms.uEnabled.value=0,this.composer.addPass(this.godRayPass),this.colorGradePass=new Fo(ad),this.composer.addPass(this.colorGradePass),this.composer.addPass(new od)}setGodRaySource(t,e){this.godRayPass&&(this.godRayPass.uniforms.uLightPos.value.copy(t),this.godRayPass.uniforms.uEnabled.value=e)}render(){this.composer&&this.composer.render()}resize(t,e){this.renderer.setSize(t,e),this.composer&&this.composer.setSize(t,e)}get domElement(){return this.renderer.domElement}}class RS{constructor(t,e,n){this.renderPipeline=t,this.cameraController=e,this.sceneManager=n,this._lastTime=0,this._running=!1,this._updateCallbacks=[],this._frame=this._frame.bind(this)}onUpdate(t){this._updateCallbacks.push(t)}start(){this._running=!0,this._lastTime=performance.now(),requestAnimationFrame(this._frame)}stop(){this._running=!1}_frame(t){if(!this._running)return;requestAnimationFrame(this._frame);const e=Math.min((t-this._lastTime)/1e3,.1);this._lastTime=t,Ct.tick(e);for(const n of this._updateCallbacks)n(e,t/1e3);this.cameraController.update(e),this.renderPipeline.render()}}class PS{constructor(t,e,n,s){this.camera=t,this.scene=e,this.domElement=n,this.cameraController=s,this.raycaster=new hS,this.pointer=new Mt,this.clickables=[],this._hoveredPlanet=null,this._onHoverCallbacks=[],n.addEventListener("pointerup",r=>this._onPointerUp(r)),n.addEventListener("pointermove",r=>this._onPointerMove(r))}addClickable(t,e){t.userData._clickHandler=e,this.clickables.push(t)}removeClickable(t){this.clickables=this.clickables.filter(e=>e!==t),delete t.userData._clickHandler}onHover(t){this._onHoverCallbacks.push(t)}_onPointerUp(t){if(!this.cameraController.wasClick()||t.button!==0)return;const e=this.domElement.getBoundingClientRect();this.pointer.x=(t.clientX-e.left)/e.width*2-1,this.pointer.y=-((t.clientY-e.top)/e.height)*2+1,this.raycaster.setFromCamera(this.pointer,this.camera);const n=this.raycaster.intersectObjects(this.clickables,!1);if(n.length>0){const s=n[0].object;s.userData._clickHandler&&s.userData._clickHandler(n[0])}}_onPointerMove(t){var r;const e=this.domElement.getBoundingClientRect();this.pointer.x=(t.clientX-e.left)/e.width*2-1,this.pointer.y=-((t.clientY-e.top)/e.height)*2+1,this.raycaster.setFromCamera(this.pointer,this.camera);const n=this.raycaster.intersectObjects(this.clickables,!1);let s=null;if(n.length>0){let a=n[0].object;for(;a;){if((r=a.userData)!=null&&r.planetId){s=a.userData.planetId;break}a=a.parent}}if(s!==this._hoveredPlanet||s){this._hoveredPlanet=s;for(const a of this._onHoverCallbacks)a(s,t.clientX,t.clientY)}}}const ld={xerion:{x:2e3,y:2e3},drakon:{x:2e3,y:2e3},crystara:{x:2e3,y:2e3},voltara:{x:2e3,y:2e3},glacius:{x:2e3,y:2e3},nebulox:{x:2e3,y:2e3},solaris:{x:2e3,y:2e3},voidex:{x:2e3,y:2e3}},IS=4e3,DS={color:"#ffdd44",size:12},cd=IS/2,hd=.05;function LS(i){const t=Math.sin(i*127.1+311.7)*43758.5453;return t-Math.floor(t)}function US(i){const t=(i.x-cd)*hd,e=(i.y-cd)*hd,n=(LS(i.x*.01+i.y*.01)-.5)*12;return new O(t,n,e)}function NS(){const i={};for(const t in ld)i[t]=US(ld[t]);return i}const Gn=`
...
`,Lf={vertex:Ai,fragment:`
  ...
  `},HS={terr:Lf,lava:FS,cryst:BS,gas:kS,ice:zS,neb:VS,star:Ql,void:GS},WS=["gas","star","void"];function XS(i){const t=new St(i);return new O(t.r,t.g,t.b)}class qS{constructor(t,e=10){this.def=t,this.radius=e,this.group=new De,this.group.userData.type="planet",this.group.userData.planetId=t.id,this._createPlanetMesh(),this._createAtmosphere(),WS.includes(t.type)&&this._createRings()}_createPlanetMesh(){const e=(il[this.def.type]||il.terr).map(XS),n=HS[this.def.type]||Lf,s=new O(1,.5,-.3).normalize();this.planetMaterial=new we({vertexShader:n.vertex,fragmentShader:n.fragment,uniforms:{uTime:{value:0},uColors:{value:e},uLightDir:{value:s}}});const r=new vn(this.radius,64,64);this.planetMesh=new Ft(r,this.planetMaterial),this.planetMesh.castShadow=!0,this.group.add(this.planetMesh)}_createAtmosphere(){const t=new St(this.def.glow),e=this.def.type==="star";this.atmosphereMaterial=new we({vertexShader:ud.vertex,fragmentShader:ud.fragment,uniforms:{uAtmColor:{value:new O(t.r,t.g,t.b)},uAtmIntensity:{value:e?1.2:.8}},side:Qe,transparent:!0,depthWrite:!1,blending:Pn});const n=new vn(this.radius*1.15,48,48);this.atmosphereMesh=new Ft(n,this.atmosphereMaterial),this.group.add(this.atmosphereMesh)}_createRings(){const t=new St(this.def.glow),e=this.radius*1.3,n=this.radius*2.2;this.ringMaterial=new we({vertexShader:dd.vertex,fragmentShader:dd.fragment,uniforms:{uColor:{value:new O(t.r,t.g,t.b)},uOpacity:{value:.5}},transparent:!0,side:Ze,depthWrite:!1});const s=new aa(e,n,128,1);this.ringMesh=new Ft(s,this.ringMaterial),this.ringMesh.rotation.x=-Math.PI/2+.15,this.ringMesh.receiveShadow=!0,this.group.add(this.ringMesh)}get clickTarget(){return this.planetMesh}update(t){this.planetMaterial.uniforms.uTime.value=t}setPosition(t,e,n){this.group.position.set(t,e,n)}dispose(){this.planetMesh.geometry.dispose(),this.planetMaterial.dispose(),this.atmosphereMesh.geometry.dispose(),this.atmosphereMaterial.dispose(),this.ringMesh&&(this.ringMesh.geometry.dispose(),this.ringMaterial.dispose())}}const To=13150286,el=9075278,nl=8173662,jS=1709320;class $S{constructor(){this.group=new De,this._build(),this.orbitAngle=Math.random()*Math.PI*2,this.orbitRadius=15,this.orbitSpeed=.1}_build(){const t=new Gs(1.5,.08,12,48),e=new fe({color:To,emissive:To,emissiveIntensity:.4,metalness:.85,roughness:.25});this.outerRing=new Ft(t,e),this.outerRing.rotation.x=Math.PI/2,this.group.add(this.outerRing);const n=new Gs(.9,.05,12,36),s=new fe({color:el,emissive:el,emissiveIntensity:.2,metalness:.8,roughness:.3});this.innerRing=new Ft(n,s),this.innerRing.rotation.x=Math.PI/2,this.group.add(this.innerRing);const r=new vn(.35,16,16),a=new fe({color:jS,emissive:nl,emissiveIntensity:.6,metalness:.5,roughness:.4});this.hub=new Ft(r,a),this.group.add(this.hub);const l=new fe({color:el,metalness:.7,roughness:.4});for(let M=0;M<4;M++){const b=M/4*Math.PI*2,v=new Vn(.03,.03,1.15,6),f=new Ft(v,l);f.rotation.z=Math.PI/2,f.rotation.y=b,f.position.set(Math.cos(b)*.75,0,Math.sin(b)*.75),this.group.add(f)}const c=new fe({color:2245768,emissive:1122884,emissiveIntensity:.3,metalness:.6,roughness:.5});for(let M=0;M<4;M++){const b=M/4*Math.PI*2+Math.PI/4,v=new _n(.5,.02,.25),f=new Ft(v,c);f.position.set(Math.cos(b)*1.5,0,Math.sin(b)*1.5),f.rotation.y=b,this.group.add(f)}const h=new Vn(.1,.15,.3,8),d=new fe({color:To,emissive:To,emissiveIntensity:.2,metalness:.8,roughness:.3}),p=new Ft(h,d);p.position.y=.3,this.group.add(p);const m=new vn(.06,8,8),y=new fe({color:nl,emissive:nl,emissiveIntensity:2});this.navLight=new Ft(m,y),this.navLight.position.y=-.25,this.group.add(this.navLight),this.group.scale.setScalar(.8)}update(t){this.orbitAngle=t*this.orbitSpeed,this.group.position.set(Math.cos(this.orbitAngle)*this.orbitRadius,Math.sin(this.orbitAngle*.3)*1.5,Math.sin(this.orbitAngle)*this.orbitRadius),this.outerRing.rotation.z=t*.32,this.innerRing.rotation.z=-t*.2;const e=Math.sin(t*3)*.5+.5;this.navLight.material.emissiveIntensity=1+e*2}dispose(){this.group.traverse(t=>{t.isMesh&&(t.geometry.dispose(),t.material.dispose())})}}const Ao=20,fd=3,pd=11.5,YS=13.5;class Lr{constructor(t){this.group=new De,this.orbitRadius=pd+Math.random()*(YS-pd),this.orbitSpeed=.3+Math.random()*.2,this.angle=Math.random()*Math.PI*2,this.phaseOffset=Math.random()*Math.PI*2,this.verticalAmp=.8+Math.random()*1.2,this.cargo=Math.random()*fd,this.returning=!1,this.returnProgress=0,this.returnStart=new O,this.stationPos=new O(0,0,15),this.mesh=this._buildMesh(),this.mesh.scale.setScalar(.3),this.group.add(this.mesh),this._createTrail()}_buildMesh(){const t=new _n(1,.6,.8),e=new fe({color:13150286,metalness:.7,roughness:.3});return new Ft(t,e)}_createTrail(){const t=new Float32Array(Ao*3);this.trailGeo=new Re,this.trailGeo.setAttribute("position",new Ce(t,3)),this.trailMat=new Tc({color:8173662,transparent:!0,opacity:.4,blending:Pn,depthWrite:!1}),this.trail=new Rf(this.trailGeo,this.trailMat),this.trailPositions=[];for(let e=0;e<Ao;e++)this.trailPositions.push(new O)}update(t,e){this.returning?this._updateReturn(t):(this._updateOrbit(t,e),this.cargo+=t*.5,this.cargo>=fd&&(this.returning=!0,this.returnProgress=0,this.returnStart.copy(this.group.position))),this._updateTrail()}_updateOrbit(t,e){this.angle+=this.orbitSpeed*t;const n=Math.sin(this.phaseOffset+e*.7)*.4;this.group.position.set(Math.cos(this.angle)*(this.orbitRadius+n),Math.sin(this.phaseOffset+e*.5)*this.verticalAmp,Math.sin(this.angle)*(this.orbitRadius+n));const s=.1,r=Math.cos(this.angle+s)*this.orbitRadius,a=Math.sin(this.angle+s)*this.orbitRadius;this.mesh.lookAt(r,this.group.position.y,a)}_updateReturn(t){if(this.returnProgress+=t*.5,this.returnProgress>=1){this.returning=!1,this.cargo=0,this.returnProgress=0;return}const e=this.returnProgress,n=e*e*(3-2*e);this.group.position.lerpVectors(this.returnStart,this.stationPos,n),this.mesh.lookAt(this.stationPos),this.trailMat.opacity=.7}_updateTrail(){for(let e=Ao-1;e>0;e--)this.trailPositions[e].copy(this.trailPositions[e-1]);this.trailPositions[0].copy(this.group.position);const t=this.trailGeo.attributes.position.array;for(let e=0;e<Ao;e++)t[e*3]=this.trailPositions[e].x,t[e*3+1]=this.trailPositions[e].y,t[e*3+2]=this.trailPositions[e].z;this.trailGeo.attributes.position.needsUpdate=!0,this.returning||(this.trailMat.opacity+=(.25-this.trailMat.opacity)*.1)}dispose(){this.mesh.traverse(t=>{t.isMesh&&(t.geometry.dispose(),t.material.dispose())}),this.trailGeo.dispose(),this.trailMat.dispose()}}class KS extends Lr{_buildMesh(){const t=new De,e=new _n(1,.6,.7),n=new fe({color:13404211,metalness:.8,roughness:.3});t.add(new Ft(e,n));const s=new Cc(.15,.6,6),r=new fe({color:8947848,metalness:.9,roughness:.2}),a=new Ft(s,r);a.rotation.z=-Math.PI/2,a.position.set(.7,-.1,0),this._drill=a,t.add(a);const l=new _n(.3,.2,.5),c=new fe({color:8173662,emissive:8173662,emissiveIntensity:.5}),h=new Ft(l,c);return h.position.set(-.3,.2,0),t.add(h),t}update(t,e){super.update(t,e),this._drill&&(this._drill.rotation.y+=t*8)}}class JS extends Lr{_buildMesh(){const t=new De,e=new vn(.4,12,12),n=new fe({color:4491468,metalness:.7,roughness:.3}),s=new Ft(e,n);s.scale.set(1.2,.7,.9),t.add(s);const r=new Vn(.02,.02,.5,4),a=new fe({color:13421772,metalness:.8,roughness:.2}),l=new Ft(r,a);l.position.set(0,.45,0),t.add(l);const c=new vn(.04,6,6),h=new fe({color:16729156,emissive:16729156,emissiveIntensity:2}),d=new Ft(c,h);d.position.set(0,.72,0),this._tip=d,t.add(d);const p=new Dr(.15,8),m=new fe({color:11184810,metalness:.9,roughness:.1,side:Ze}),y=new Ft(p,m);return y.position.set(.35,.1,0),y.rotation.y=Math.PI/2,t.add(y),t}update(t,e){super.update(t,e),this._tip&&(this._tip.material.emissiveIntensity=1+Math.sin(e*5)*1.5)}}class ZS extends Lr{_buildMesh(){const t=new De,e=new vn(.3,10,10),n=new fe({color:5592405,metalness:.8,roughness:.3});t.add(new Ft(e,n));const s=new vn(.05,6,6),r=new fe({color:16720384,emissive:16720384,emissiveIntensity:2});for(let l=-1;l<=1;l+=2){const c=new Ft(s,r);c.position.set(.2,.1,l*.12),t.add(c)}this._legs=[];const a=new fe({color:7829367,metalness:.7,roughness:.4});for(let l=0;l<6;l++){const c=l/6*Math.PI*2,h=new Vn(.015,.015,.4,4),d=new Ft(h,a);d.position.set(Math.cos(c)*.25,-.15,Math.sin(c)*.25),d.rotation.z=Math.cos(c)*.6,d.rotation.x=Math.sin(c)*.6,this._legs.push(d),t.add(d)}return t}update(t,e){super.update(t,e);for(let n=0;n<this._legs.length;n++){const s=n/this._legs.length*Math.PI*2;this._legs[n].rotation.z+=Math.sin(e*4+s)*t*2}}}class QS extends Lr{_buildMesh(){const t=new De,e=new Vn(.35,.35,.12,16),n=new fe({color:4500172,metalness:.7,roughness:.3});t.add(new Ft(e,n));const s=new vn(.2,12,8,0,Math.PI*2,0,Math.PI/2),r=new fe({color:8969727,metalness:.5,roughness:.2,transparent:!0,opacity:.7}),a=new Ft(s,r);a.position.y=.06,t.add(a);const l=new Gs(.45,.03,8,24),c=new fe({color:13150286,emissive:13150286,emissiveIntensity:.5,metalness:.8,roughness:.2});this._ring1=new Ft(l,c),this._ring1.rotation.x=Math.PI/2,t.add(this._ring1);const h=new Gs(.32,.02,8,20);this._ring2=new Ft(h,c.clone()),this._ring2.rotation.x=Math.PI/2,t.add(this._ring2);const d=new Dr(.15,8),p=new fe({color:4508927,emissive:4508927,emissiveIntensity:2,side:Ze}),m=new Ft(d,p);return m.rotation.x=Math.PI/2,m.position.y=-.07,t.add(m),t}update(t,e){super.update(t,e),this._ring1&&(this._ring1.rotation.z=e*2),this._ring2&&(this._ring2.rotation.z=-e*3)}}class tE extends Lr{_buildMesh(){const t=new De,e=new _n(1.2,.5,.8),n=new fe({color:6706483,metalness:.85,roughness:.3});t.add(new Ft(e,n));const s=new _n(.1,.4,.7),r=new fe({color:8943428,metalness:.9,roughness:.2}),a=new Ft(s,r);a.position.set(.65,0,0),t.add(a);const l=new Vn(.2,.25,.15,8),c=new fe({color:7824964,metalness:.8,roughness:.3}),h=new Ft(l,c);h.position.set(-.1,.3,0),t.add(h);const d=new Vn(.05,.06,.7,6),p=new fe({color:5592405,metalness:.9,roughness:.2});this._cannon=new Ft(d,p),this._cannon.rotation.z=Math.PI/2,this._cannon.position.set(.25,.35,0),t.add(this._cannon);const m=new _n(1,.15,.15),y=new fe({color:3355443,metalness:.6,roughness:.6});for(let v=-1;v<=1;v+=2){const f=new Ft(m,y);f.position.set(0,-.2,v*.45),t.add(f)}const M=new Dr(.06,6),b=new fe({color:16737792,emissive:16737792,emissiveIntensity:1.5,side:Ze});for(let v=0;v<2;v++){const f=new Ft(M,b);f.position.set(-.6,-.05+v*.15,0),f.rotation.y=Math.PI/2,t.add(f)}return t}update(t,e){super.update(t,e),this._cannon&&(this._cannon.rotation.y=Math.sin(e*.5)*.3)}}const eE=32,md=[KS,JS,ZS,QS,tE];class nE{constructor(){this.group=new De,this.robots=[],this.targetCount=0}setStationPosition(t){for(const e of this.robots)e.stationPos.copy(t);this._stationPos=t.clone()}syncCount(t){for(this.targetCount=Math.min(t,eE);this.robots.length<this.targetCount;){const e=this.robots.length,n=md[e%md.length],s=new n(e);this._stationPos&&s.stationPos.copy(this._stationPos),this.robots.push(s),this.group.add(s.group),this.group.add(s.trail)}for(let e=0;e<this.robots.length;e++)this.robots[e].group.visible=e<this.targetCount,this.robots[e].trail.visible=e<this.targetCount}update(t,e){for(let n=0;n<this.targetCount&&n<this.robots.length;n++)this.robots[n].update(t,e)}dispose(){for(const t of this.robots)t.dispose();this.robots=[]}}const ws=600,gd=18;class iE{constructor(t=13150286){this.group=new De;const e=new Float32Array(ws*3),n=new Float32Array(ws),s=new Float32Array(ws),r=new Float32Array(ws*3),a=new St(t);this.velocities=[];for(let c=0;c<ws;c++){const h=11+Math.random()*gd,d=Math.random()*Math.PI*2,p=Math.acos(2*Math.random()-1),m=h*Math.sin(p)*Math.cos(d),y=h*Math.sin(p)*Math.sin(d),M=h*Math.cos(p);e[c*3]=m,e[c*3+1]=y,e[c*3+2]=M,n[c]=.15+Math.random()*.5,s[c]=.15+Math.random()*.35;const b=.8+Math.random()*.4,v=a.clone().multiplyScalar(b);r[c*3]=v.r,r[c*3+1]=v.g,r[c*3+2]=v.b;const f=new O((Math.random()-.5)*.3,(Math.random()-.5)*.15,(Math.random()-.5)*.3),D=Math.sqrt(m*m+M*M)+.001,I=.08;f.x+=-M/D*I,f.z+=m/D*I,this.velocities.push(f)}const l=new Re;l.setAttribute("position",new Ce(e,3)),l.setAttribute("size",new Ce(n,1)),l.setAttribute("aOpacity",new Ce(s,1)),l.setAttribute("aColor",new Ce(r,3)),this.material=new we({vertexShader:`
      ...
      `,uniforms:{uTime:{value:0},uOpacity:{value:1},uColor1:{value:new O(r.r,r.g,r.b)},uColor2:{value:new O(a.r,a.g,a.b)},uColor3:{value:new O(l.r,l.g,l.b)}},transparent:!0,depthWrite:!1,side:Ze,blending:Pn});const c=new qs(s,s);this.mesh=new Ft(c,this.material),this.mesh.renderOrder=-10}update(t,e){this.material.uniforms.uTime.value=t,this.mesh.lookAt(e.position)}dispose(){this.mesh.geometry.dispose(),this.material.dispose()}}const Ln=400;class sE{constructor(t=9074016){this.group=new De,this._orbitAngles=new Float32Array(Ln),this._orbitRadii=new Float32Array(Ln),this._orbitSpeeds=new Float32Array(Ln),this._orbitHeights=new Float32Array(Ln),this._scales=new Float32Array(Ln),this._selfRotAxes=[],this._selfRotAngles=new Float32Array(Ln),this._selfRotSpeeds=new Float32Array(Ln);const e=new Pc(1,1),n=new fe({roughness:.65,metalness:.08,color:new St(t),emissive:new St(.06,.038,.014)});n.onBeforeCompile=a=>{a.fragmentShader=a.fragmentShader.replace("#include <output_fragment>",`
        vec3 rimViewDir = normalize(-vViewPosition);
        float rim = 1.0 - max(dot(rimViewDir, normal), 0.0);
        rim = pow(rim, 2.0) * 1.8;
        outgoingLight += diffuseColor.rgb * rim;
        #include <output_fragment>
        `)},this.mesh=new eS(e,n,Ln),this.mesh.instanceMatrix.setUsage(S0),this.mesh.castShadow=!1,this.mesh.receiveShadow=!1;const s=new Te,r=new St;for(let a=0;a<Ln;a++){this._orbitAngles[a]=Math.random()*Math.PI*2,this._orbitRadii[a]=20+Math.random()*15,this._orbitSpeeds[a]=(.03+Math.random()*.06)*(Math.random()<.5?1:-1),this._orbitHeights[a]=(Math.random()-.5)*4,this._scales[a]=.05+Math.random()*.2,this._selfRotAxes.push(new O(Math.random(),Math.random(),Math.random()).normalize()),this._selfRotAngles[a]=Math.random()*Math.PI*2,this._selfRotSpeeds[a]=.2+Math.random()*.8;const l=this._orbitAngles[a],c=this._orbitRadii[a];s.position.set(Math.cos(l)*c,this._orbitHeights[a],Math.sin(l)*c),s.scale.setScalar(this._scales[a]),s.rotation.set(Math.random()*Math.PI*2,Math.random()*Math.PI*2,0),s.updateMatrix(),this.mesh.setMatrixAt(a,s.matrix);const h=.06+Math.random()*.05,d=.12+Math.random()*.25,p=.28+Math.random()*.28;r.setHSL(h,d,p),this.mesh.setColorAt(a,r)}this.mesh.instanceMatrix.needsUpdate=!0,this.mesh.instanceColor&&(this.mesh.instanceColor.needsUpdate=!0),this.group.add(this.mesh),this._dummy=new Te,this._quat=new Xs}update(t){const e=this._dummy,n=this._quat;for(let s=0;s<Ln;s++){this._orbitAngles[s]+=this._orbitSpeeds[s]*t,this._selfRotAngles[s]+=this._selfRotSpeeds[s]*t;const r=this._orbitAngles[s],a=this._orbitRadii[s];e.position.set(Math.cos(r)*a,this._orbitHeights[s],Math.sin(r)*a),e.scale.setScalar(this._scales[s]),n.setFromAxisAngle(this._selfRotAxes[s],this._selfRotAngles[s]),e.quaternion.copy(n),e.updateMatrix(),this.mesh.setMatrixAt(s,e.matrix)}this.mesh.instanceMatrix.needsUpdate=!0}dispose(){this.mesh.geometry.dispose(),this.mesh.material.dispose()}}class rE{constructor(t=16755251,e=1){this.group=new De,this.intensity=e;const n=new St(t);this.centralSprite=this._createGlowSprite(n,8,1),this.group.add(this.centralSprite),this.rings=[];const s=[{color:n.clone().lerp(new St(16777215),.3),size:3,offset:12,opacity:.3},{color:n.clone().lerp(new St(16729088),.4),size:2,offset:18,opacity:.15},{color:n.clone(),size:1.5,offset:25,opacity:.1}];for(const r of s){const a=this._createGlowSprite(r.color,r.size,r.opacity);a.position.y=r.offset,this.rings.push(a),this.group.add(a)}}_createGlowSprite(t,e,n){const s=document.createElement("canvas");s.width=128,s.height=128;const r=s.getContext("2d"),a=64,l=64,c=r.createRadialGradient(a,l,0,a,l,64);c.addColorStop(0,`rgba(255,255,255,${n})`),c.addColorStop(.15,`rgba(${Math.floor(t.r*255)},${Math.floor(t.g*255)},${Math.floor(t.b*255)},${n*.7})`),c.addColorStop(.5,`rgba(${Math.floor(t.r*255)},${Math.floor(t.g*255)},${Math.floor(t.b*255)},${n*.15})`),c.addColorStop(1,"rgba(0,0,0,0)"),r.fillStyle=c,r.fillRect(0,0,128,128),r.strokeStyle=`rgba(${Math.floor(t.r*255)},${Math.floor(t.g*255)},${Math.floor(t.b*255)},${n*.3})`,r.lineWidth=1;for(let m=0;m<4;m++){const y=m/4*Math.PI;r.beginPath(),r.moveTo(a+Math.cos(y)*10,l+Math.sin(y)*10),r.lineTo(a+Math.cos(y)*60,l+Math.sin(y)*60),r.stroke()}const h=new Ac(s),d=new oa({map:h,transparent:!0,blending:Pn,depthWrite:!1,depthTest:!1}),p=new wc(d);return p.scale.setScalar(e),p}update(t,e){const n=.85+Math.sin(e*1.2)*.15;this.centralSprite.scale.setScalar(8*n*this.intensity),new O().subVectors(this.group.getWorldPosition(new O),t.position).normalize();for(let r=0;r<this.rings.length;r++){const a=.7+Math.sin(e*.8+r*1.5)*.3;this.rings[r].scale.setScalar((3-r)*a*this.intensity)}}dispose(){this.group.traverse(t=>{t.isSprite&&(t.material.map.dispose(),t.material.dispose())})}}class oE{constructor(t,e){var c;this.id=t.id,this.def=t,this.group=new De,this.group.position.copy(e),this.group.userData.type="solarSystem",this.group.userData.planetId=t.id;const n=t.orbit||{radius:0,speed:0,inclination:0,phase:0};this.orbitRadius=n.radius,this.orbitSpeed=n.speed,this.orbitInclination=n.inclination,this.orbitPhase=n.phase,this._cachedPlanetWorldPos=new O,this._createOrbitLine(t),this.orbitGroup=new De,this.group.add(this.orbitGroup),this.planet=new qS(t),this.orbitGroup.add(this.planet.group),this.station=new $S,this.orbitGroup.add(this.station.group),this.robotManager=new nE,this.orbitGroup.add(this.robotManager.group),this._lastStationSync=0,this.dustCloud=new iE(t.glow),this.orbitGroup.add(this.dustCloud.group);const s=((c=t.nebulaPalette)==null?void 0:c.colors)||["#110022","#220044","#003344","#220055","#004455"],r=s[4]||s[2]||"#003344";if(this.nebulaVolume=new _r(s[1]||s[0],s[3]||s[1],r,80),this.nebulaVolume.mesh.position.set(0,0,-20),this.orbitGroup.add(this.nebulaVolume.mesh),this.nebulaVolume2=new _r(s[3]||s[0],s[0],s[2]||s[1],70),this.nebulaVolume2.mesh.position.set(5,3,-30),this.nebulaVolume2.mesh.rotation.z=Math.PI/4,this.orbitGroup.add(this.nebulaVolume2.mesh),this.nebulaVolume3=new _r(s[2]||s[0],s[4]||s[2],s[0],55),this.nebulaVolume3.mesh.position.set(-14,7,-12),this.nebulaVolume3.mesh.rotation.z=-Math.PI/5,this.orbitGroup.add(this.nebulaVolume3.mesh),this.nebulaVolume4=new _r(s[0],s[2]||s[1],s[3]||s[2],42),this.nebulaVolume4.mesh.position.set(10,-5,-42),this.nebulaVolume4.mesh.rotation.z=Math.PI/3,this.nebulaVolume4.mesh.rotation.x=Math.PI/8,this.orbitGroup.add(this.nebulaVolume4.mesh),this.asteroidBelt=null,t.type!=="star"){const h=new St(t.col||t.glow).lerp(new St(8943462),.65);this.asteroidBelt=new sE(h.getHex()),this.orbitGroup.add(this.asteroidBelt.group)}this.lensFlare=null,t.type==="star"&&(this.lensFlare=new rE(t.glow,1),this.orbitGroup.add(this.lensFlare.group));const a=new St(t.glow);this.rimLight=new Jl(a,.8,50,1.5),this.rimLight.position.set(-8,3,12),this.orbitGroup.add(this.rimLight);const l=a.clone().lerp(new St(16777215),.3);this.fillLight=new Jl(l,.3,35,2),this.fillLight.position.set(5,-6,5),this.orbitGroup.add(this.fillLight),this._createLabel(t.name),this._onRobotsChanged=()=>this._syncRobots(),this._onPlanetChanged=()=>this._syncRobots(),this._onStateLoaded=()=>this._syncRobots(),this._syncRobots(),Ct.on("robotsChanged",this._onRobotsChanged),Ct.on("planetChanged",this._onPlanetChanged),Ct.on("stateLoaded",this._onStateLoaded),this._updateOrbit(0)}_createOrbitLine(t){if(this.orbitRadius===0)return;const e=128,n=[],s=this.orbitRadius,r=this.orbitInclination;for(let c=0;c<=e;c++){const h=c/e*Math.PI*2;n.push(new O(Math.cos(h)*s,Math.sin(r)*Math.sin(h)*s*.3,Math.sin(h)*s))}const a=new Re().setFromPoints(n),l=new St(t.glow);this.orbitLineMaterial=new Tc({color:l,transparent:!0,opacity:.06,depthWrite:!1}),this.orbitLine=new Rf(a,this.orbitLineMaterial),this.group.add(this.orbitLine)}_syncRobots(){const e=Ct.activePlanet===this.id?Ct.robots:0;this.robotManager.syncCount(e)}_createLabel(t){const e=document.createElement("canvas");e.width=256,e.height=64;const n=e.getContext("2d");n.font="bold 32px Orbitron, monospace",n.textAlign="center",n.fillStyle="#c8a84e",n.fillText(t,128,42);const s=new Ac(e);s.minFilter=gn;const r=new oa({map:s,transparent:!0,depthWrite:!1});this.label=new wc(r),this.label.scale.set(12,3,1),this.label.position.set(0,14,0),this.orbitGroup.add(this.label)}get clickTarget(){return this.planet.clickTarget}get worldPosition(){return this.group.position}get planetWorldPosition(){return this.orbitGroup.getWorldPosition(this._cachedPlanetWorldPos),this._cachedPlanetWorldPos}_updateOrbit(t){if(this.orbitRadius===0)return;const e=t*this.orbitSpeed+this.orbitPhase,n=this.orbitRadius;this.orbitGroup.position.set(Math.cos(e)*n,Math.sin(this.orbitInclination)*Math.sin(e)*n*.3,Math.sin(e)*n)}updateLOD(t,e,n,s){this._updateOrbit(e),t<180&&this.planet.update(e);const r=t<80;this.station.group.visible=r,r&&(this.station.update(e),e-this._lastStationSync>.2&&(this._lastStationSync=e,this.robotManager.setStationPosition(this.station.group.position)));const a=t<60;if(this.robotManager.group.visible=a,a&&n!==void 0&&this.robotManager.update(n,e),this.asteroidBelt){const h=Ni.smoothstep(220,180,t);this.asteroidBelt.group.visible=h>0,h>0&&n!==void 0&&(this.asteroidBelt.update(n),this.asteroidBelt.mesh.material.opacity=h,this.asteroidBelt.mesh.material.transparent=h<.99)}const l=Ni.smoothstep(160,130,t);this.dustCloud.group.visible=l>0,l>0&&n!==void 0&&(this.dustCloud.setOpacity(.35*l),this.dustCloud.update(n,e));const c=Ni.smoothstep(350,300,t);if(this.nebulaVolume.mesh.visible=c>0,this.nebulaVolume2.mesh.visible=c>0,this.nebulaVolume3.mesh.visible=c>0,this.nebulaVolume4.mesh.visible=c>0,c>0&&s&&(this.nebulaVolume.material.uniforms.uOpacity.value=c,this.nebulaVolume.update(e,s),this.nebulaVolume2.material.uniforms.uOpacity.value=c*.7,this.nebulaVolume2.update(e,s),this.nebulaVolume3.material.uniforms.uOpacity.value=c*.9,this.nebulaVolume3.update(e,s),this.nebulaVolume4.material.uniforms.uOpacity.value=c*.8,this.nebulaVolume4.update(e,s)),this.lensFlare){const h=Ni.smoothstep(450,390,t);this.lensFlare.group.visible=h>0,h>0&&s&&(this.lensFlare.group.traverse(d=>{d.isSprite&&(d.material.opacity=h)}),this.lensFlare.update(s,e))}if(this.label.visible=t>15&&t<300,this.label.visible){const h=Math.min(1,t/50);this.label.scale.set(12*h,3*h,1)}if(this.planet.atmosphereMesh){const h=Ni.smoothstep(280,240,t);if(this.planet.atmosphereMesh.visible=h>0,h>0){const d=this.planet.def.type==="star"?1.2:.8;this.planet.atmosphereMaterial.uniforms.uAtmIntensity.value=d*h}}if(this.planet.ringMesh){const h=Ni.smoothstep(250,210,t);this.planet.ringMesh.visible=h>0,h>0&&(this.planet.ringMaterial.uniforms.uOpacity.value=.5*h)}this.rimLight.visible=t<100,this.fillLight.visible=t<100}dispose(){Ct.off("robotsChanged",this._onRobotsChanged),Ct.off("planetChanged",this._onPlanetChanged),Ct.off("stateLoaded",this._onStateLoaded),this.planet.dispose(),this.station.dispose(),this.robotManager.dispose(),this.dustCloud.dispose(),this.nebulaVolume.dispose(),this.nebulaVolume2.dispose(),this.nebulaVolume3.dispose(),this.nebulaVolume4.dispose(),this.asteroidBelt&&this.asteroidBelt.dispose(),this.orbitLine&&(this.orbitLine.geometry.dispose(),this.orbitLineMaterial.dispose()),this.lensFlare&&this.lensFlare.dispose(),this.label&&(this.label.material.map.dispose(),this.label.material.dispose())}}function aE(i){const t=new St(i);return new O(t.r,t.g,t.b)}class lE{constructor(t){if(this.group=new De,this.size=t.size,this.size===0)return;const n=il.star.map(aE),s=new St(t.color);n[0]=new O(n[0].x*.5+s.r*.5,n[0].y*.5+s.g*.5,n[0].z*.5+s.b*.5),this.material=new we({vertexShader:Ql.vertex,fragmentShader:Ql.fragment,uniforms:{uTime:{value:0},uColors:{value:n},uLightDir:{value:new O(1,.5,-.3).normalize()}}});const r=new vn(this.size,32,32);this.mesh=new Ft(r,this.material),this.group.add(this.mesh),this.light=new Jl(s,1.5,50,1.5),this.group.add(this.light)}update(t){this.size!==0&&(this.material.uniforms.uTime.value=t)}dispose(){this.size!==0&&(this.mesh.geometry.dispose(),this.material.dispose())}}class cE{constructor(){this.group=new De,this.systems={},this.worldPositions=NS(),this.centralStar=new lE(DS);const t=this.worldPositions[qi[0].id];this.centralStar.group.position.copy(t),this.group.add(this.centralStar.group),this._createSystems(),this._createCosmicNebulas()}_createCosmicNebulas(){const t=[{pos:[280,60,-150],size:380,c:["#05011a","#2211bb","#004466"]},{pos:[-320,-80,200],size:320,c:["#1a0005","#881133","#001833"]},{pos:[180,120,380],size:420,c:["#040010","#331199","#002244"]},{pos:[-250,30,-400],size:350,c:["#080010","#220077","#441188"]},{pos:[500,-60,100],size:300,c:["#100004","#662211","#001122"]},{pos:[-180,100,-280],size:260,c:["#000a18","#113377","#003322"]}];this._cosmicNebulas=t.map(({pos:e,size:n,c:s})=>{const r=new _r(s[0],s[1],s[2],n);return r.mesh.position.set(...e),r.material.uniforms.uOpacity.value=1,this.group.add(r.mesh),r})}_createSystems(){for(const t of qi){const e=this.worldPositions[t.id],n=new oE(t,e);this.systems[t.id]=n,this.group.add(n.group)}}getSystem(t){return this.systems[t]}getPosition(t){return this.worldPositions[t]}getPlanetWorldPosition(t){var e;return(e=this.systems[t])==null?void 0:e.planetWorldPosition}getClickTargets(){const t=[];for(const e in this.systems)t.push({mesh:this.systems[e].clickTarget,planetId:e,system:this.systems[e]});return t}update(t,e,n){const s=t.position;this.centralStar.update(n);for(const r of this._cosmicNebulas)r.update(n,t);for(const r in this.systems){const a=this.systems[r],l=s.distanceTo(a.planetWorldPosition);l>430?(a.group.visible=!0,a._updateOrbit(n),Math.random()<.1&&a.updateLOD(l,n,e,t)):a.updateLOD(l,n,e,t)}}dispose(){this.centralStar.dispose();for(const t in this.systems)this.systems[t].dispose();for(const t of this._cosmicNebulas)t.dispose()}}const Ts=2048,hE=2e3,Kn=2e3;class uE{constructor(t){this.scene=t,this._createStarCubemap(),this._createTwinkleStars(),this._createNebulaBackground(),this._targetNeb1=new O(.18,.05,.4),this._targetNeb2=new O(.65,.35,.08),this._targetNeb3=new O(.05,.45,.55),this._targetMilkyWay=.55,this.targetDensity=.55}_createStarCubemap(){const t=[];for(let n=0;n<6;n++){const s=document.createElement("canvas");s.width=Ts,s.height=Ts;const r=s.getContext("2d");r.fillStyle="#050810",r.fillRect(0,0,Ts,Ts);for(let a=0;a<hE;a++){const l=Math.random()*Ts,c=Math.random()*Ts,h=.3+Math.random()*.7,d=.3+Math.random()*3.7,p=Math.random();let m,y,M;if(p<.15?(m=.55,y=.65,M=1):p<.35?(m=.75,y=.82,M=1):p<.6?(m=1,y=1,M=.95):p<.8?(m=1,y=.9,M=.7):(m=1,y=.6,M=.4),r.fillStyle=`rgba(${Math.floor(m*255)},${Math.floor(y*255)},${Math.floor(M*255)},${h})`,r.beginPath(),r.arc(l,c,d,0,Math.PI*2),r.fill(),h>.55&&d>.8){const b=d*4,v=r.createRadialGradient(l,c,0,l,c,b);v.addColorStop(0,`rgba(${Math.floor(m*255)},${Math.floor(y*255)},${Math.floor(M*255)},${h*.18})`),v.addColorStop(1,"rgba(0,0,0,0)"),r.fillStyle=v,r.beginPath(),r.arc(l,c,b,0,Math.PI*2),r.fill()}if(Math.random()<.05&&h>.65&&d>1.2){const b=d*18;r.save();for(let v=0;v<4;v++){const f=v/4*Math.PI,D=Math.cos(f),I=Math.sin(f),C=h*.3,z=r.createLinearGradient(l,c,l+D*b,c+I*b);z.addColorStop(0,`rgba(${Math.floor(m*255)},${Math.floor(y*255)},${Math.floor(M*255)},${C})`),z.addColorStop(1,"rgba(0,0,0,0)"),r.strokeStyle=z,r.lineWidth=.8,r.beginPath(),r.moveTo(l,c),r.lineTo(l+D*b,c+I*b),r.stroke();const N=r.createLinearGradient(l,c,l-D*b,c-I*b);N.addColorStop(0,`rgba(${Math.floor(m*255)},${Math.floor(y*255)},${Math.floor(M*255)},${C})`),N.addColorStop(1,"rgba(0,0,0,0)"),r.strokeStyle=N,r.beginPath(),r.moveTo(l,c),r.lineTo(l-D*b,c-I*b),r.stroke()}r.restore()}}t.push(s)}const e=new xc(t);e.colorSpace=ln,e.needsUpdate=!0,this.scene.background=e}_createTwinkleStars(){const t=new Float32Array(Kn*3),e=new Float32Array(Kn*3),n=new Float32Array(Kn);this._twinklePhases=new Float32Array(Kn),this._twinkleSpeeds=new Float32Array(Kn),this._twinkleBaseSizes=new Float32Array(Kn);for(let r=0;r<Kn;r++){const a=300+Math.random()*500,l=Math.random()*Math.PI*2,c=Math.acos(2*Math.random()-1);t[r*3]=a*Math.sin(c)*Math.cos(l),t[r*3+1]=a*Math.sin(c)*Math.sin(l),t[r*3+2]=a*Math.cos(c);const h=Math.random();h<.2?(e[r*3]=.6,e[r*3+1]=.72,e[r*3+2]=1):h<.45?(e[r*3]=.85,e[r*3+1]=.92,e[r*3+2]=1):h<.7?(e[r*3]=1,e[r*3+1]=.98,e[r*3+2]=.92):h<.88?(e[r*3]=1,e[r*3+1]=.88,e[r*3+2]=.68):(e[r*3]=1,e[r*3+1]=.65,e[r*3+2]=.45),n[r]=Math.random()<.1?3:1,this._twinklePhases[r]=Math.random()*Math.PI*2,this._twinkleSpeeds[r]=1+Math.random()*3,this._twinkleBaseSizes[r]=1+Math.random()*2.5}const s=new Re;s.setAttribute("position",new Ce(t,3)),s.setAttribute("color",new Ce(e,3)),s.setAttribute("aGlowFactor",new Ce(n,1)),this._twinkleSizeAttr=new Ce(new Float32Array(Kn),1),s.setAttribute("size",this._twinkleSizeAttr),this._twinkleMaterial=new we({vertexShader:`
        attribute float size;
      ...
      `,transparent:!0,blending:Pn,depthWrite:!1}),this._twinklePoints=new Pf(s,this._twinkleMaterial),this._twinklePoints.renderOrder=-500,this.scene.add(this._twinklePoints)}_createNebulaBackground(){const t=new qs(2,2);this.nebulaMaterial=new we({vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
      ...
      `,uniforms:{uTime:{value:0},uResolution:{value:new Mt(window.innerWidth,window.innerHeight)},uDensity:{value:.55},uOpacity:{value:1},uNebulaColor1:{value:new O(.18,.05,.4)},uNebulaColor2:{value:new O(.65,.35,.08)},uNebulaColor3:{value:new O(.05,.45,.55)},uMilkyWayStrength:{value:.55}},transparent:!0,depthWrite:!1,depthTest:!1,blending:Pn}),this.nebulaMesh=new Ft(t,this.nebulaMaterial),this.nebulaMesh.renderOrder=-1e3,this.nebulaMesh.frustumCulled=!1,this.scene.add(this.nebulaMesh)}setPlanetPalette(t){if(!(t!=null&&t.nebulaPalette))return;const{colors:e,density:n}=t.nebulaPalette;if(e[0]){const s=new St(e[0]);this._targetNeb1.set(s.r*.7,s.g*.4,s.b)}if(e[2]){const s=new St(e[2]);this._targetNeb2.set(s.r+.15,s.g*.8,s.b*.3)}if(e[4]){const s=new St(e[4]);this._targetNeb3.set(s.r*.2,s.g*.6+.2,s.b*.8+.1)}this.targetDensity=n||.55,this._targetMilkyWay=.4+Math.random()*.25}update(t){const e=this.nebulaMaterial.uniforms;e.uTime.value=t;const n=.012;e.uNebulaColor1.value.lerp(this._targetNeb1,n),e.uNebulaColor2.value.lerp(this._targetNeb2,n),e.uNebulaColor3.value.lerp(this._targetNeb3,n),e.uDensity.value+=(this.targetDensity-e.uDensity.value)*n,e.uMilkyWayStrength.value+=(this._targetMilkyWay-e.uMilkyWayStrength.value)*n;const s=this._twinkleSizeAttr.array;for(let r=0;r<Kn;r++){const a=.4+.6*(Math.sin(t*this._twinkleSpeeds[r]+this._twinklePhases[r])*.5+.5);s[r]=this._twinkleBaseSizes[r]*a}this._twinkleSizeAttr.needsUpdate=!0}resize(t,e){this.nebulaMaterial.uniforms.uResolution.value.set(t,e)}}const dE=8,_d=.6;class fE{constructor(t){this.scene=t,this.activeRings=[]}spawn(t,e,n){const s=new aa(.3,.5,32),r=new sa({color:13150286,transparent:!0,opacity:.8,side:Ze,depthWrite:!1,blending:Pn}),a=new Ft(s,r);a.position.copy(t),a.lookAt(t.clone().add(e)),this.scene.add(a);const l=this._createNumberSprite(n);l.position.copy(t).add(e.clone().multiplyScalar(.5)),this.scene.add(l);const c={ring:a,sprite:l,age:0,normal:e.clone(),startPos:t.clone()};for(this.activeRings.push(c);this.activeRings.length>dE;){const h=this.activeRings.shift();this.scene.remove(h.ring),this.scene.remove(h.sprite),h.ring.geometry.dispose(),h.ring.material.dispose(),h.sprite.material.map.dispose(),h.sprite.material.dispose()}}_createNumberSprite(t){const e=document.createElement("canvas");e.width=128,e.height=64;const n=e.getContext("2d");n.font="bold 36px Orbitron, monospace",n.textAlign="center",n.fillStyle="#c8a84e",n.fillText("+"+t,64,44);const s=new Ac(e);s.minFilter=gn;const r=new oa({map:s,transparent:!0,depthWrite:!1,depthTest:!1}),a=new wc(r);return a.scale.set(3,1.5,1),a}update(t){for(let e=this.activeRings.length-1;e>=0;e--){const n=this.activeRings[e];if(n.age+=t,n.age>=_d){this.scene.remove(n.ring),this.scene.remove(n.sprite),n.ring.geometry.dispose(),n.ring.material.dispose(),n.sprite.material.map.dispose(),n.sprite.material.dispose(),this.activeRings.splice(e,1);continue}const s=n.age/_d,r=1+s*4;n.ring.scale.setScalar(r),n.ring.material.opacity=(1-s)*.8,n.sprite.position.copy(n.startPos).add(n.normal.clone().multiplyScalar(.5+s*3)),n.sprite.material.opacity=1-s}}}const pE={name:"GodRayShader",uniforms:{tDiffuse:{value:null},uLightPos:{value:new Mt(.5,.5)},uDecay:{value:.96},uDensity:{value:.85},uWeight:{value:.35},uExposure:{value:.18},uEnabled:{value:0}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `};function mE(){const i=document.getElementById("game-container"),t=new CS(i),e=new uS,n=new cn(60,window.innerWidth/window.innerHeight,.1,2e3),s=new xS(n,t.domElement);t.setupPostProcessing(e.scene,n),t.addGodRayPass(pE);const r=new PS(n,e.scene,t.domElement,s),a=new RS(t,s,e),l=new uE(e.scene);l.setPlanetPalette(Ct.activePlanetDef);const c=new fE(e.scene),h=new cE;e.add(h.group);const d=Object.values(h.systems).map(M=>({get position(){return M.planetWorldPosition},radius:M.planet.radius}));s.setPlanetColliders(d);for(const M of h.getClickTargets())r.addClickable(M.mesh,b=>{const{planetId:v,system:f}=M;Ct.ownedPlanets.includes(v)?Ct.switchPlanet(v):Ct.colonizePlanet(v),s.trackObject(()=>f.planetWorldPosition,55)});const p=h.getSystem(Ct.activePlanet);if(p){const M=p.planetWorldPosition;s.targetTarget.copy(M),s.target.copy(M),s.spherical.radius=30,s.targetSpherical.radius=30,s.trackObject(()=>p.planetWorldPosition,55)}Ct.on("planetChanged",M=>{const b=h.getSystem(M);b&&s.trackObject(()=>b.planetWorldPosition,55),l.setPlanetPalette(Ct.activePlanetDef)}),Ct.on("planetColonized",M=>{const b=h.getSystem(M);b&&s.trackObject(()=>b.planetWorldPosition,55),l.setPlanetPalette(Ct.activePlanetDef)});const m=new Mt,y=new O;return a.onUpdate((M,b)=>{h.update(n,M,b),l.update(b),c.update(M),t.tick(b);const v=Ct.activePlanetDef;if((v==null?void 0:v.type)==="star"){const f=h.getSystem(v.id);if(f){y.copy(f.worldPosition).project(n),m.set((y.x+1)*.5,(y.y+1)*.5);const D=n.position.distanceTo(f.worldPosition),I=Math.abs(y.x)<1.8&&Math.abs(y.y)<1.8&&y.z<1,C=Ni.smoothstep(350,80,D);t.setGodRaySource(m,I?C:0)}}else t.setGodRaySource(m.set(.5,.5),0)}),window.addEventListener("resize",()=>{const M=window.innerWidth,b=window.innerHeight;n.aspect=M/b,n.updateProjectionMatrix(),t.resize(M,b),l.resize(M,b)}),a.start(),{sceneManager:e,camera:n,cameraController:s,renderPipeline:t,animationLoop:a,inputManager:r,galaxy:h,skybox:l}}const pn=i=>i>=1e12?(i/1e12).toFixed(2)+"T":i>=1e9?(i/1e9).toFixed(2)+"B":i>=1e6?(i/1e6).toFixed(2)+"M":i>=1e3?(i/1e3).toFixed(1)+"K":Math.floor(i)+"";class gE{constructor(t){if(this.game=t,this.activeTab="mining",this.minimized=!1,this.updateTimer=0,this.dom={vOre:document.getElementById("vOre"),rOre:document.getElementById("rOre"),vCrys:document.getElementById("vCrys"),rCrys:document.getElementById("rCrys"),vEnrg:document.getElementById("vEnrg"),rEnrg:document.getElementById("rEnrg"),rcCrys:document.getElementById("rcCrys"),sepCrys:document.getElementById("sepCrys"),rcEnrg:document.getElementById("rcEnrg"),barUpgrades:document.getElementById("bar-upgrades"),barMinimize:document.getElementById("bar-minimize"),bottomBar:document.getElementById("bottom-bar"),upgTooltip:document.getElementById("upg-tooltip"),planetTooltip:document.getElementById("planet-tooltip"),toast:document.getElementById("toast")},this._setupTabs(),this._setupMultiplier(),this._setupMinimize(),this._setupPlanetHover(),this._setupEvents(),this._renderUpgrades(),Ct._offlineEarnings){const e=Ct._offlineEarnings,n=Math.floor(e.elapsed/3600),s=Math.floor(e.elapsed%3600/60),r=n>0?`${n}h ${s}m`:`${s}m`;this.toast(`OFFLINE ${r}: +${pn(e.earned)} ORE`),delete Ct._offlineEarnings}else this.toast("WELCOME, COMMANDER");t.animationLoop.onUpdate(e=>this.update(e))}_setupTabs(){document.querySelectorAll(".bar-tab").forEach(t=>{t.addEventListener("pointerdown",e=>{e.stopPropagation(),this.activeTab=t.dataset.cat,document.querySelectorAll(".bar-tab").forEach(n=>n.classList.toggle("active",n===t)),this._renderUpgrades()})})}_updateTabBadges(){const t=["mining","robots","tech"];for(const e of t){const n=Bo.filter(r=>r.cat===e&&Ct.canAfford(r.id)).length,s=document.getElementById(`tbadge-${e}`);s&&(s.textContent=n>0?n:"")}}_setupMultiplier(){document.getElementById("m1").addEventListener("pointerdown",()=>this._setMult(1)),document.getElementById("m10").addEventListener("pointerdown",()=>this._setMult(10)),document.getElementById("m100").addEventListener("pointerdown",()=>this._setMult(100))}_setupMinimize(){this.dom.barMinimize.addEventListener("pointerdown",t=>{t.stopPropagation(),this._toggleMinimize()}),window.addEventListener("keydown",t=>{t.code==="Tab"&&(t.preventDefault(),this._toggleMinimize())})}_toggleMinimize(){this.minimized=!this.minimized,this.dom.bottomBar.classList.toggle("minimized",this.minimized),this.dom.barMinimize.textContent=this.minimized?"▲":"▼"}_setupPlanetHover(){this.game.inputManager.onHover((t,e,n)=>{const s=this.dom.planetTooltip;if(!t){s.classList.remove("visible");return}const r=qi.find(c=>c.id===t);if(!r)return;const a=Ct.ownedPlanets.includes(t),l=Ct.activePlanet===t;s.innerHTML=`
    ...
    `,t.classList.add("open"),document.getElementById("panel-back").addEventListener("click",()=>this._closeSubPanel())}_closeSubPanel(){const t=document.getElementById("landing-subpanel");t.classList.remove("open"),setTimeout(()=>{t.innerHTML=""},300)}_updateFooter(){const t=document.getElementById("footer-left"),e=document.getElementById("footer-right"),n=zg();Hh()?(t.textContent="SAVE: CLOUD + LOCAL",e.textContent=n.email||n.displayName||"GOOGLE USER"):(t.textContent="SAVE: LOCAL ONLY",e.textContent="OFFLINE")}}async function vE(){const i=new Uf({inGame:!0});await i.init(),i.show();const t=await i.waitForChoice();t.action!=="resume"&&(t.action==="newgame"?(localStorage.removeItem("astro_save"),location.reload()):t.action==="cloud"&&t.saveData&&(localStorage.setItem("astro_save",JSON.stringify(t.saveData)),location.reload()))}async function yE(){kg();const i=mE(),t=new Uf;await t.init(),t.show();const e=await t.waitForChoice();let n=null;if(e.action==="continue"?n=Jf():e.action==="cloud"?n=e.saveData:e.action==="newgame"&&(localStorage.removeItem("astro_save"),Ct.reset()),e.action!=="newgame"&&Bg(),n){Ct.deserialize(n);const l=Ct.applyOfflineEarnings();l&&l.earned>0&&(Ct._offlineEarnings=l)}Zf(),new gE(i);let s=!1;const r=async()=>{s||(s=!0,await vE(),s=!1)};document.addEventListener("keydown",l=>{l.key==="Escape"&&r()});const a=document.getElementById("menu-btn");a&&a.addEventListener("click",r)}yE();
