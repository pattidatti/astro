...
export const TECH_NODES = [
  // ─── ROBOTS branch ───────────────────────────────────────────────────────
  // col/row properties define position in the 4-column CSS Grid layout:
  //   col 0 = Energy Bot chain, col 1 = Miner Bot, col 2 = Builder Bot, col 3 = Scout Bot
  //   row 1 = bot unlock, rows 2–5 = upgrade depth within column
  {
    id: 'energy_bot',
    name: 'ENERGY BOT',
    icon: '🔋',
    desc: 'Harvests energy from the planet.',
    cost: 0, free: true, requires: [], tier: 0, branch: 'robots', col: 0, row: 1,
  },
  {
    id: 'miner_bot',
    name: 'MINER BOT',
    ...
    cost: 50, free: false, requires: ['energy_bot'], tier: 1, branch: 'robots', col: 1, row: 1,
  },
  {
    id: 'builder_bot',
    name: 'BUILDER BOT',
    ...
    cost: 800, free: false, requires: ['energy_bot'], tier: 1, branch: 'robots', col: 2, row: 1,
  },
  {
    id: 'scout_bot',
    name: 'SCOUT BOT',
    ...
    cost: 500, free: false, requires: ['miner_bot'], tier: 2, branch: 'robots', col: 3, row: 2,
  },
  {
    ...
    cost: 1500, free: false, requires: ['energy_bot'], tier: 2, branch: 'robots', col: 0, row: 2,
  },
  {
    ...
    cost: 600, free: false, requires: ['miner_bot'], tier: 2, branch: 'robots', col: 1, row: 2,
  },
  {
    ...
    cost: 3000, free: false, requires: ['builder_bot'], tier: 3, branch: 'robots', col: 2, row: 3,
  },
  {
    id: 'crystal_focus',
    name: 'CRYSTAL FOCUS',
    ...
    cost: 3000, free: false, requires: ['scout_bot'], tier: 3, branch: 'robots', col: 3, row: 3,
  },
  {
    ...
    cost: 4000, free: false, requires: ['energy_efficiency'], tier: 3, branch: 'robots', col: 0, row: 3,
  },
  {
    ...
    cost: 4000, free: false, requires: ['mining_efficiency'], tier: 3, branch: 'robots', col: 1, row: 3,
  },
  {
    id: 'scout_speed',
    name: 'DEEP SCAN',
    ...
    cost: 2500, free: false, requires: ['scout_bot'], tier: 3, branch: 'robots', col: 3, row: 3,
  },
  {
    id: 'neural_sync',
    name: 'NEURAL SYNC',
    ...
    cost: 8000, free: false, requires: ['energy_efficiency_2'], tier: 4, branch: 'robots', col: 0, row: 4,
  },
  {
    id: 'deep_mining',
    name: 'CORE DRILL',
    ...
    cost: 8000, free: false, requires: ['mining_efficiency_2'], tier: 4, branch: 'robots', col: 1, row: 4,
  },

  // ─── Robot upgrade chains (global — apply to all planets) ────────────────
  { id: 'energy_speed_1', name: 'ENERGY SPEED I',   icon: '💨', branch: 'robots', tier: 2, col: 0, row: 2, desc: 'Energy Bots move 20% faster.',  cost: 250,   requires: ['energy_bot'],     free: false },
  { id: 'energy_speed_2', name: 'ENERGY SPEED II',  icon: '💨', branch: 'robots', tier: 3, col: 0, row: 3, desc: 'Energy Bots move 20% faster.',  cost: 3500,  requires: ['energy_speed_1'], free: false },
  { id: 'energy_speed_3', name: 'ENERGY SPEED III', icon: '💨', branch: 'robots', tier: 4, col: 0, row: 4, desc: 'Energy Bots move 20% faster.',  cost: 45000, requires: ['energy_speed_2'], free: false },
  { id: 'energy_load_1',  name: 'ENERGY LOAD I',    icon: '📦', branch: 'robots', tier: 2, col: 0, row: 2, desc: 'Energy Bots carry 30% more.',   cost: 350,   requires: ['energy_bot'],     free: false },
  { id: 'energy_load_2',  name: 'ENERGY LOAD II',   icon: '📦', branch: 'robots', tier: 3, col: 0, row: 3, desc: 'Energy Bots carry 30% more.',   cost: 4500,  requires: ['energy_load_1'],  free: false },
  { id: 'energy_load_3',  name: 'ENERGY LOAD III',  icon: '📦', branch: 'robots', tier: 4, col: 0, row: 4, desc: 'Energy Bots carry 30% more.',   cost: 65000, requires: ['energy_load_2'],  free: false },

  { id: 'miner_speed_1',  name: 'MINER SPEED I',    icon: '💨', branch: 'robots', tier: 2, col: 1, row: 2, desc: 'Miner Bots move 20% faster.',   cost: 200,   requires: ['miner_bot'],      free: false },
  { id: 'miner_speed_2',  name: 'MINER SPEED II',   icon: '💨', branch: 'robots', tier: 3, col: 1, row: 3, desc: 'Miner Bots move 20% faster.',   cost: 3000,  requires: ['miner_speed_1'],  free: false },
  { id: 'miner_speed_3',  name: 'MINER SPEED III',  icon: '💨', branch: 'robots', tier: 4, col: 1, row: 4, desc: 'Miner Bots move 20% faster.',   cost: 40000, requires: ['miner_speed_2'],  free: false },
  { id: 'miner_load_1',   name: 'MINER LOAD I',     icon: '📦', branch: 'robots', tier: 2, col: 1, row: 2, desc: 'Miner Bots carry 30% more.',    cost: 300,   requires: ['miner_bot'],      free: false },
  { id: 'miner_load_2',   name: 'MINER LOAD II',    icon: '📦', branch: 'robots', tier: 3, col: 1, row: 3, desc: 'Miner Bots carry 30% more.',    cost: 4000,  requires: ['miner_load_1'],   free: false },
  { id: 'miner_load_3',   name: 'MINER LOAD III',   icon: '📦', branch: 'robots', tier: 4, col: 1, row: 4, desc: 'Miner Bots carry 30% more.',    cost: 60000, requires: ['miner_load_2'],   free: false },

  { id: 'builder_speed_1', name: 'BUILDER SPEED I',   icon: '💨', branch: 'robots', tier: 2, col: 2, row: 2, desc: 'Builder Bots move 20% faster.', cost: 300,   requires: ['builder_bot'],      free: false },
  { id: 'builder_speed_2', name: 'BUILDER SPEED II',  icon: '💨', branch: 'robots', tier: 3, col: 2, row: 3, desc: 'Builder Bots move 20% faster.', cost: 4000,  requires: ['builder_speed_1'],  free: false },
  { id: 'builder_speed_3', name: 'BUILDER SPEED III', icon: '💨', branch: 'robots', tier: 4, col: 2, row: 4, desc: 'Builder Bots move 20% faster.', cost: 55000, requires: ['builder_speed_2'],  free: false },
  { id: 'builder_load_1',  name: 'BUILDER LOAD I',    icon: '📦', branch: 'robots', tier: 2, col: 2, row: 2, desc: 'Builder Bots carry 30% more.',  cost: 400,   requires: ['builder_bot'],      free: false },
  { id: 'builder_load_2',  name: 'BUILDER LOAD II',   icon: '📦', branch: 'robots', tier: 3, col: 2, row: 3, desc: 'Builder Bots carry 30% more.',  cost: 5000,  requires: ['builder_load_1'],   free: false },
  { id: 'builder_load_3',  name: 'BUILDER LOAD III',  icon: '📦', branch: 'robots', tier: 4, col: 2, row: 4, desc: 'Builder Bots carry 30% more.',  cost: 70000, requires: ['builder_load_2'],   free: false },

  { id: 'scout_speed_1',  name: 'SCOUT SPEED I',    icon: '💨', branch: 'robots', tier: 3, col: 3, row: 3, desc: 'Scout Bots move 20% faster.',   cost: 350,   requires: ['scout_bot'],      free: false },
  { id: 'scout_speed_2',  name: 'SCOUT SPEED II',   icon: '💨', branch: 'robots', tier: 4, col: 3, row: 4, desc: 'Scout Bots move 20% faster.',   cost: 4500,  requires: ['scout_speed_1'],  free: false },
  { id: 'scout_speed_3',  name: 'SCOUT SPEED III',  icon: '💨', branch: 'robots', tier: 5, col: 3, row: 5, desc: 'Scout Bots move 20% faster.',   cost: 60000, requires: ['scout_speed_2'],  free: false },
  { id: 'scout_load_1',   name: 'SCOUT LOAD I',     icon: '📦', branch: 'robots', tier: 3, col: 3, row: 3, desc: 'Scout Bots carry 30% more.',    cost: 450,   requires: ['scout_bot'],      free: false },
  { id: 'scout_load_2',   name: 'SCOUT LOAD II',    icon: '📦', branch: 'robots', tier: 4, col: 3, row: 4, desc: 'Scout Bots carry 30% more.',    cost: 5500,  requires: ['scout_load_1'],   free: false },
  { id: 'scout_load_3',   name: 'SCOUT LOAD III',   icon: '📦', branch: 'robots', tier: 5, col: 3, row: 5, desc: 'Scout Bots carry 30% more.',    cost: 80000, requires: ['scout_load_2'],   free: false },
